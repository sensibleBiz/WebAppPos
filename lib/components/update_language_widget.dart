...
import 'update_language_model.dart';
export 'update_language_model.dart';

class UpdateLanguageWidget extends StatefulWidget {
  const UpdateLanguageWidget({
    super.key,
    this.docRef,
  });
  ...
  @override
  State<UpdateLanguageWidget> createState() => _UpdateLanguageWidgetState();
}

class _UpdateLanguageWidgetState extends State<UpdateLanguageWidget> {
  late UpdateLanguageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateLanguageModel());
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: StreamBuilder<LanguageRecord>(
              stream: LanguageRecord.getDocument(widget.docRef!),
              builder: (context, snapshot) {
                ...
                final containerLanguageRecord = snapshot.data!;
                return Container(
                  decoration: BoxDecoration(),
                  child: Padding(
                                ...
                                onTap: () async {
                                  if (_model.textLanguageNameTextController
                                    ...
                                    await containerLanguageRecord.reference
                                      ...
                                      createdBy:
                                          containerLanguageRecord.createdBy,
                                      createdDate:
                                          containerLanguageRecord.createdDate,
                                    ));
                                    await showDialog(
                                      context: context,
                                      builder: (alertDialogContext) {
                                        return WebViewAware(
                                          child: AlertDialog(
                                            title: Text('Update'),
                                            content: Text(
                                                'Languages Record Successfully Update'),
                                            actions: [
                                              TextButton(
