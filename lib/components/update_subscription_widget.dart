...
import 'update_subscription_model.dart';
export 'update_subscription_model.dart';

class UpdateSubscriptionWidget extends StatefulWidget {
  const UpdateSubscriptionWidget({
    super.key,
    this.docRef,
  });
...
class _UpdateSubscriptionWidgetState extends State<UpdateSubscriptionWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateSubscriptionModel());

    _model.textPlanNameFocusNode ??= FocusNode();
    ...
    _model.textSubscriptionAmountFocusNode ??= FocusNode();
        ...
        children: [
          Container(
            ...
            child: StreamBuilder<SubscriptionRecord>(
              stream: SubscriptionRecord.getDocument(widget.docRef!),
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  if (containerSubscriptionRecord.link !=
                                          null &&
                                      containerSubscriptionRecord.link != '') {
