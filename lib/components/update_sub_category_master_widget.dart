...
import 'update_sub_category_master_model.dart';
export 'update_sub_category_master_model.dart';
...
class _UpdateSubCategoryMasterWidgetState
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateSubCategoryMasterModel());

    _model.textSubCategoryTypeNameFocusNode ??= FocusNode();
          ...
          Container(
            ...
            child: StreamBuilder<SubCategoryRecord>(
              ...
              builder: (context, snapshot) {
                ...
                final container1SubCategoryRecord = snapshot.data!;
                return Container(
                  decoration: BoxDecoration(),
                  child: Padding(
                                                ...
                                                child: StreamBuilder<
                                                  ...
                                                  builder: (context, snapshot) {
                                                    ...
                                                    return FlutterFlowDropDown<
                                                        String>(
                                                      controller: _model
                                                              .dropDownCategoryNameValueController ??=
                                                          FormFieldController<
                                                              String>(
                                                        _model.dropDownCategoryNameValue ??=
                            ...
                            return Container(
                              ...
                              child: StreamBuilder<List<CategoryMasterRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<CategoryMasterRecord>
                                      rowBottomCategoryMasterRecordList =
                                      snapshot.data!;
                                  final rowBottomCategoryMasterRecord =
                                      rowBottomCategoryMasterRecordList
                                              .isNotEmpty
                                          ? rowBottomCategoryMasterRecordList
                                              .first
                                          ...
                                          onTap: () async {
                                            ...
                                            if (_model.textSubCategoryTypeNameTextController
                                              ...
                                              if (_model
                                                  ...
                                                  container1SubCategoryRecord
                                                      .name) {
                                                await container1SubCategoryRecord
                                                    .reference
                                                    .update(
                                                  ...
                                                  categoryMasterRef: FFAppState()
                                                              .dropdown ==
                                                          true
                                                      ? rowBottomCategoryMasterRecord
                                                          ?.reference
                                                      : widget.category,
                                                  createdBy:
                                                      container1SubCategoryRecord
                                                  ...
                                                  builder:
                                                    ...
                                                    return WebViewAware(
                                                      child: AlertDialog(
                                                        title: Text('Update'),
                                                        content: Text(
                                                            'Sub Category Master Record  Successfully Updated'),
                                                        actions: [
                                                          TextButton(
                                                            onPressed: () =>
                                                                Navigator.pop(
                                                    ...
                                                    builder:
                                                      ...
                                                      return WebViewAware(
                                                        child: AlertDialog(
                                                          title: Text('Alert'),
                                                          content: Text(
                                                              'Sub Category Name Is Already Added'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
