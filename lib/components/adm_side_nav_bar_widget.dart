      ...
      child: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(45.0, 5.0, 45.0, 0.0),
                child: Image.asset(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  context.pushNamed('BusinessMaster');
                                },
                                child: Container(
                                  width: 280.0,
                                  height: 55.0,
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                highlightColor: Colors.transparent,
                                onTap: () async {
                                  context.pushNamed('SubCategoryMaster');
                                },
                                child: Container(
                                  width: 280.0,
                                  height: 55.0,
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    ...
                    if ((((_model.getEmail?.role == 'admin') ||
                            ...
                            true) &&
                        (_model.getEmail?.outletId == 'YfhsFpsyloYaeBWC39lS')) {
                      context.pushNamed(
                        'AdminUserManualView',
