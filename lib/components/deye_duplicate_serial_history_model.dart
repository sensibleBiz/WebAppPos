...
import 'deye_duplicate_serial_history_widget.dart'
    show DeyeDuplicateSerialHistoryWidget;
...
class DeyeDuplicateSerialHistoryModel
    extends FlutterFlowModel<DeyeDuplicateSerialHistoryWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in DeyeDuplicateSerialHistory widget.
  List<LeadsManagementRecord>? leadDocsFetched;
  // Stores action output result for [Custom Action - getSortedComplaintsAssignedDateTime] action in DeyeDuplicateSerialHistory widget.
