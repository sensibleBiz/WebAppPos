...
import 'update_unit_type_model.dart';
export 'update_unit_type_model.dart';
...
class UpdateUnitTypeWidget extends StatefulWidget {
  ...
  @override
  State<UpdateUnitTypeWidget> createState() => _UpdateUnitTypeWidgetState();
}

class _UpdateUnitTypeWidgetState extends State<UpdateUnitTypeWidget> {
  late UpdateUnitTypeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateUnitTypeModel());
          ...
          Container(
            ...
            child: StreamBuilder<UnitTypeRecord>(
              ...
              builder: (context, snapshot) {
                ...
                final containerUnitTypeRecord = snapshot.data!;
                return Container(
                  decoration: BoxDecoration(),
                  child: Padding(
                                ...
                                onTap: () async {
                                  if (_model.textUnitNameController.text !=
                                    ...
                                    await containerUnitTypeRecord.reference
                                      ...
                                      createdBy:
                                          containerUnitTypeRecord.createdBy,
                                    ));
                                    await showDialog(
                                      context: context,
                                      builder: (alertDialogContext) {
                                        return WebViewAware(
                                          child: AlertDialog(
                                            title: Text('Update'),
                                            content: Text(
                                                'Unit Type Record Successfully Updated'),
                                            actions: [
                                              TextButton(
