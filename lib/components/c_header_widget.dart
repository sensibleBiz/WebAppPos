...
import '/components/c_edit_profile_widget.dart';
...
import 'c_header_model.dart';
export 'c_header_model.dart';

class CHeaderWidget extends StatefulWidget {
  const CHeaderWidget({super.key});

  @override
  State<CHeaderWidget> createState() => _CHeaderWidgetState();
}

class _CHeaderWidgetState extends State<CHeaderWidget> {
  late CHeaderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CHeaderModel());
