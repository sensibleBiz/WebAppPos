...
import 'update_service_point_master_model.dart';
export 'update_service_point_master_model.dart';
...
class UpdateServicePointMasterWidget extends StatefulWidget {
  ...
  @override
  State<UpdateServicePointMasterWidget> createState() =>
...
class _UpdateServicePointMasterWidgetState
  ...
  late UpdateServicePointMasterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateServicePointMasterModel());
          ...
          Container(
            ...
            child: StreamBuilder<ServicePointRecord>(
              ...
              builder: (context, snapshot) {
                ...
                final containerServicePointRecord = snapshot.data!;
                return Container(
                  decoration: BoxDecoration(),
                  child: Padding(
                                ...
                                onTap: () async {
                                  if (_model.textServicePointMasterNameTextController
                                    ...
                                    await containerServicePointRecord.reference
                                      ...
                                      createdBy:
                                          containerServicePointRecord.createdBy,
                                    ));
                                    await showDialog(
                                      context: context,
