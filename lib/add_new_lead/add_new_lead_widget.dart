...
class _AddNewLeadWidgetState extends State<AddNewLeadWidget> {
  ...
  void initState() {
    ...
    _model.bNameTextController ??= TextEditingController();
    _model.bNameFocusNode ??= FocusNode();
                                                ...
                                                children: [
                                                  ...
                                                  StreamBuilder<
                                                    ...
                                                    builder:
                                                      ...
                                                      List<BusinessTypeRecord>
                                                          dropDownBTypeBusinessTypeRecordList =
                                                          snapshot.data!;
                                                      return FlutterFlowDropDown<
                                                          String>(
                                                        controller: _model
                                                                .dropDownBTypeValueController ??=
                                                            FormFieldController<
                                                                String>(
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: FlutterFlowDropDown<
                                                      String>(
                                                    controller: _model
                                                            .dropDownPriorityValueController ??=
                                                        FormFieldController<
                                                            String>(null),
                                                    options: [
                                                      'cold',
