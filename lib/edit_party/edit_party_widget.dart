...
import 'edit_party_model.dart';
export 'edit_party_model.dart';
...
class EditPartyWidget extends StatefulWidget {
  ...
  static String routeName = 'EditParty';
  static String routePath = 'editParty';

  @override
  State<EditPartyWidget> createState() => _EditPartyWidgetState();
}

class _EditPartyWidgetState extends State<EditPartyWidget> {
  late EditPartyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditPartyModel());

    _model.textFieldPartyNameFocusNode ??= FocusNode();

    _model.textFieldMobileFocusNode ??= FocusNode();

    _model.textFieldGstNumberFocusNode ??= FocusNode();
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Expanded(
                                        child: TextFormField(
                                          controller: _model
                                                  .textFieldPartyNameTextController ??=
                                              TextEditingController(
                                            text: containerPartyRecord?.name,
                                          ),
                                          focusNode: _model
                                              .textFieldPartyNameFocusNode,
                                          autofocus: true,
                                          obscureText: false,
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: TextFormField(
                                            controller: _model
                                                    .textFieldGstNumberTextController ??=
                                                TextEditingController(
                                              text: containerPartyRecord?.gstNo,
                                            ),
                                            focusNode: _model
                                                .textFieldGstNumberFocusNode,
                                            autofocus: true,
                                            obscureText: false,
                                            decoration: InputDecoration(
                                              hintText: 'GST No.',
                                        ...
                                        Expanded(
                                          child: TextFormField(
                                            controller: _model
                                                ...
                                                TextEditingController(
                                              text: containerPartyRecord?.email,
                                            ),
                                            focusNode:
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        ...
                                        if (_model.textFieldPartyNameTextController
                                                    .text !=
                                                null &&
                                            _model.textFieldPartyNameTextController
                                                    .text !=
                                                '') {
                                          _model.party =
                                              await actions.partyList();
                                          _shouldSetState = true;

                                          await containerPartyRecord!.reference
                                          ...
                                          await showDialog(
                                            ...
                                            builder: (alertDialogContext) {
                                              return WebViewAware(
                                                child: AlertDialog(
                                                  title:
                                                      Text('Party Successfull'),
                                                  content: Text(
                                                      'Party Update Successfull'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
