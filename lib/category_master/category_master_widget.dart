...
class CategoryMasterWidget extends StatefulWidget {
  const CategoryMasterWidget({Key key}) : super(key: key);

  @override
  _CategoryMasterWidgetState createState() => _CategoryMasterWidgetState();
}

class _CategoryMasterWidgetState extends State<CategoryMasterWidget> {
  Map<CategoryMasterRecord, String> dropDownValueMap = {};
