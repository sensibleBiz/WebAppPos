...
import 'add_service_point_master_model.dart';
export 'add_service_point_master_model.dart';
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            if (_model.textServicePointMasterNameTextController
                              ...
                              context.pushNamed(ServicePointWidget.routeName);
                            } else {
                              if (_model.formKey.currentState == null ||
                                  !_model.formKey.currentState!.validate()) {
                                return;
