...
import 'add_sub_category_master_model.dart';
export 'add_sub_category_master_model.dart';
        ...
        children: [
          StreamBuilder<List<SubCategoryRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              List<SubCategoryRecord> containerSubCategoryRecordList =
                  snapshot.data!;
                            ...
                            child: StreamBuilder<List<CategoryMasterRecord>>(
                              stream: queryCategoryMasterRecord(
                                queryBuilder: (categoryMasterRecord) =>
                                  ...
                                  'name',
                                  isEqualTo: _model.dropDownCategoryNameValue,
                                ),
                                singleRecord: true,
                              ),
                              builder: (context, snapshot) {
                                            ...
                                            builder: (alertDialogContext) {
                                              return WebViewAware(
                                                child: AlertDialog(
                                                  title: Text('Create'),
                                                  content: Text(
                                                      'Sub Category Master Add Successfully '),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
