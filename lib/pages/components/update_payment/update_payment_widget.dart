...
import 'update_payment_model.dart';
export 'update_payment_model.dart';
...
class UpdatePaymentWidget extends StatefulWidget {
  ...
  @override
  State<UpdatePaymentWidget> createState() => _UpdatePaymentWidgetState();
}

class _UpdatePaymentWidgetState extends State<UpdatePaymentWidget> {
  late UpdatePaymentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdatePaymentModel());
          ...
          Container(
            ...
            child: StreamBuilder<PaymentModeRecord>(
              ...
              builder: (context, snapshot) {
                ...
                final containerPaymentModeRecord = snapshot.data!;
                                ...
                                onTap: () async {
                                  if (_model.textPaymentNameTextController
                                    ...
                                    await containerPaymentModeRecord.reference
                                      ...
                                      createdBy:
                                          containerPaymentModeRecord.createdBy,
                                      createdDate: containerPaymentModeRecord
                                          .createdDate,
                                    ));
                                    await showDialog(
                                      context: context,
                                      builder: (alertDialogContext) {
                                        return WebViewAware(
                                          child: AlertDialog(
                                            title: Text('Update'),
                                            content: Text(
                                                'Payment Mode Record Successfully  Updated'),
                                            actions: [
                                              TextButton(
