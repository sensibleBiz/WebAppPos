...
import 'add_state_model.dart';
export 'add_state_model.dart';

class AddStateWidget extends StatefulWidget {
  ...
  @override
  State<AddStateWidget> createState() => _AddStateWidgetState();
}

class _AddStateWidgetState extends State<AddStateWidget> {
  late AddStateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddStateModel());
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: StreamBuilder<List<ZoneRecord>>(
                      stream: queryZoneRecord(
                        queryBuilder: (zoneRecord) =>
                            zoneRecord.orderBy('zone'),
                      ),
                      builder: (context, snapshot) {
                        ...
                        List<ZoneRecord> dropDownZoneRecordList =
                            snapshot.data!;

                        return FlutterFlowDropDown<String>(
                          controller: _model.dropDownValueController ??=
                              FormFieldController<String>(null),
                          options: dropDownZoneRecordList
                              .map((e) => e.zone)
                              .toList(),
                          onChanged: (val) =>
                          ...
                          onTap: () async {
                            ...
                            if (_model.textLanguageNameTextController.text !=
                                ...
                                _model.textLanguageNameTextController.text !=
                                    '') {
                              var stateRecordReference =
                                  StateRecord.collection.doc();
                              await stateRecordReference
                                  .set(createStateRecordData(
                                name: functions.toCapitalLetter1(
                                    _model.textLanguageNameTextController.text),
                                code: int.tryParse(
                                    _model.textLanguageCodeTextController.text),
                                zone: _model.dropDownValue,
                              ));
                              _model.doc = StateRecord.getDocumentFromData(
                                  createStateRecordData(
                              ...
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return WebViewAware(
                                    child: AlertDialog(
                                      title: Text('Create'),
                                      content: Text('State  Add Successfully'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
