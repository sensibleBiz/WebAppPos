...
import 'c_add_category_model.dart';
export 'c_add_category_model.dart';

class CAddCategoryWidget extends StatefulWidget {
  const CAddCategoryWidget({
    super.key,
    this.codeLen,
  });
  ...
  @override
  State<CAddCategoryWidget> createState() => _CAddCategoryWidgetState();
}

class _CAddCategoryWidgetState extends State<CAddCategoryWidget> {
  late CAddCategoryModel _model;
                                ...
                                if (_model.textFieldNameTextController.text !=
                                  ...
                                  if (!_model.dupRef!) {
                                    ...
                                    await _model.catDoc!.reference
                                      ...
                                      id: functions.getDocIdFromDocRefCategory(
                                    ...
                                    context
                                        .pushNamed(CCategoryWidget.routeName);
