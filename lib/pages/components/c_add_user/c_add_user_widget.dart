...
import 'c_add_user_model.dart';
export 'c_add_user_model.dart';

class CAddUserWidget extends StatefulWidget {
  const CAddUserWidget({
    super.key,
    this.codeLen,
    this.userRef,
  });
  ...
  @override
  State<CAddUserWidget> createState() => _CAddUserWidgetState();
}

class _CAddUserWidgetState extends State<CAddUserWidget> {
  late CAddUserModel _model;
                        ...
                        Expanded(
                          child: FlutterFlowCheckboxGroup(
                            ...
                            onChanged: (val) => safeSetState(
                                () => _model.checkboxGroup1Values = val),
                            controller: _model.checkboxGroup1ValueController ??=
                            ...
                            initialized: _model.checkboxGroup1Values != null,
                          ),
                        ),
                        Expanded(
                          child: FlutterFlowCheckboxGroup(
                            ...
                            controller: _model.checkboxGroup2ValueController ??=
                                FormFieldController<List<String>>(
                              [],
                            ),
                            activeColor:
                            ...
                            initialized: _model.checkboxGroup2Values != null,
                          ),
                        ),
                      ],
                    ),
                          ...
                          onTap: () async {
                            if (_model.textFieldNameTextController.text !=
                              ...
                              await widget!.userRef!
                                ...
                                id: functions.getDocIdFromDocRefUserAccount(
                                    widget!.userRef),
                              ));
                              await showDialog(
                                context: context,
