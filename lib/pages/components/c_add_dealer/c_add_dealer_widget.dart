...
import 'c_add_dealer_model.dart';
export 'c_add_dealer_model.dart';

class CAddDealerWidget extends StatefulWidget {
  const CAddDealerWidget({
    super.key,
    this.codeLen,
    this.userRef,
  });
  ...
  @override
  State<CAddDealerWidget> createState() => _CAddDealerWidgetState();
}

class _CAddDealerWidgetState extends State<CAddDealerWidget> {
  late CAddDealerModel _model;
  ...
  void initState() {
    ...
    _model.remarkTextController1 ??= TextEditingController();
    _model.remarkFocusNode1 ??= FocusNode();

    _model.remarkTextController2 ??= TextEditingController();
    _model.remarkFocusNode2 ??= FocusNode();
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              FFAppState().addToUserMobileNumbers(
                                  FFAppState().userMobileNumberAddDealer);
                              safeSetState(() {});
                              FFAppState().addToUserMobileNumbers(_model
                                  .searchMobileTextFieldTextController.text);
                              safeSetState(() {});
                              _model.checkUser =
                                  await queryUserProfileRecordOnce(
                                queryBuilder: (userProfileRecord) =>
                                    userProfileRecord.whereIn('mobile',
                                        FFAppState().userMobileNumbers),
                                singleRecord: true,
                              ).then((s) => s.firstOrNull);
                              _model.checkDuplicate =
                                  await queryDealersRecordOnce(
                              ...
                              _model.res = await actions.userAsDealerExists(
                                _model.checkUser,
                                _model.checkDuplicate,
                              );
                              if (_model.res!) {
                              ...
                              context.pushNamed(CDealerAccountWidget.routeName);
                                    ...
                                    child: Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            isDense: true,
                                            labelText: _model.checkUser?.name,
                                            hintStyle:
                                                FlutterFlowTheme.of(context)
                                                    .bodySmall
                                                    .override(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: TextFormField(
                                            controller:
                                                _model.remarkTextController1,
                                            focusNode: _model.remarkFocusNode1,
                                            autofocus: true,
                                            obscureText: false,
                                            decoration: InputDecoration(
                                              isDense: true,
                                            ...
                                            keyboardType: TextInputType.number,
                                            validator: _model
                                                .remarkTextController1Validator
                                                .asValidator(context),
                                          ),
                                        ),
                                      ),
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: TextFormField(
                                            controller:
                                                _model.remarkTextController2,
                                            focusNode: _model.remarkFocusNode2,
                                            autofocus: true,
                                            textCapitalization:
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        ...
                                        if ((_model.fetchedDuplicateDealer !=
                                                null) ==
                                            true) {
                                          await showDialog(
                                            context: context,
                                            builder: (alertDialogContext) {
                                              return WebViewAware(
                                                child: AlertDialog(
                                                  title: Text(
                                                      '${_model.checkUser?.name} is already dealer'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
                                          ...
                                          var dealersRecordReference =
                                              DealersRecord.createDoc(
                                                  FFAppState().outletRef!);
                                          await dealersRecordReference
                                              .set(createDealersRecordData(
                                            address: _model.checkUser?.address,
                                            isActive: true,
                                            state: _model.dropDownStateValue,
                                            userProfileId:
                                                _model.checkUser != null
                                                    ? _model.checkUser?.id
                                                    : '0',
                                            isDeleted: false,
                                            dealerCode: _model
                                                .remarkTextController2.text,
                                            firmName: _model
                                                .companyNameTextController.text,
                                            mobile: FFAppState()
                                                .userMobileNumberAddDealer,
                                            dealerName: _model.checkUser != null
                                                ? _model.checkUser?.name
                                                : _model
                                                    .textFieldNameTextController
                                                    .text,
                                            gst: _model
                                          ...
                                          _model.createDealer =
                                              DealersRecord.getDocumentFromData(
                                                  ...
                                                  dealersRecordReference);
                                          _shouldSetState = true;

                                          await _model.createDealer!.reference
                                              .update(createDealersRecordData(
                                            id: _model
                                                .createDealer?.reference.id,
                                          ));
                                          Navigator.pop(context);
                                          if (_shouldSetState)
                                            safeSetState(() {});
