...
import 'deye_edit_user_model.dart';
export 'deye_edit_user_model.dart';

class DeyeEditUserWidget extends StatefulWidget {
  const DeyeEditUserWidget({
    super.key,
    this.userRef,
    this.id,
  });
  ...
  @override
  State<DeyeEditUserWidget> createState() => _DeyeEditUserWidgetState();
}

class _DeyeEditUserWidgetState extends State<DeyeEditUserWidget> {
  late DeyeEditUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeyeEditUserModel());
    ...
    _model.textController1 ??=
        TextEditingController(text: widget!.userRef?.name);
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??=
        TextEditingController(text: widget!.userRef?.mobile);
    ...
    _model.textController4 ??=
        TextEditingController(text: widget!.userRef?.password);
                            ...
                            onTap: () async {
                              if (_model.textController1.text != null &&
                                ...
                                await widget!.userRef!.reference
                                  ...
                                  city: _model.dropDownCityValue != null &&
