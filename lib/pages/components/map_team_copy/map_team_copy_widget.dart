...
import 'map_team_copy_model.dart';
export 'map_team_copy_model.dart';

class MapTeamCopyWidget extends StatefulWidget {
  const MapTeamCopyWidget({
    super.key,
    this.codeLen,
    this.userProfile,
  });
  ...
  @override
  State<MapTeamCopyWidget> createState() => _MapTeamCopyWidgetState();
}

class _MapTeamCopyWidgetState extends State<MapTeamCopyWidget> {
  late MapTeamCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MapTeamCopyModel());
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return Column(
                                        ...
                                        children: List.generate(
                                            columnLeadStagesRecordList.length,
                                            (columnIndex) {
                                              ...
                                              children: [
                                                ...
                                                wrapWithModel(
                                                  ...
                                                  child: StagesDropDownWidget(
                                                    key: Key(
                                                      'Keymba_${columnLeadStagesRecord.id}',
                                                    ),
                            ...
                            child: Container(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  if (_model.dropDownTeamValue != null &&
                                    ...
                                    if (_model.dropDownTeamValue != null &&
                                      ...
                                      await teamTreeRecordReference.set({
                                        ...createTeamTreeRecordData(
                                          ...
                                          userProfileId:
                                              widget!.userProfile?.reference.id,
                                          teamHeadProfileId: _model
                                              ...
                                              ? _model.dropDownTeamValue
                                              : '0',
                                          roleInZone: _model.dropDownRoleValue,
                                          isActive: true,
                                          zoneHeadProfileId:
                                              _model.dropDownZoneHeadValue,
                                          uid: widget!.userProfile?.uid,
                                          workMode: 'AVAILABLE',
                                          zone: _model.dropDownZoneListValue
                                              ?.firstOrNull,
                                      ...
                                      _model.doc =
                                          TeamTreeRecord.getDocumentFromData({
                                        ...createTeamTreeRecordData(
                                          userName: widget!.userProfile?.name,
                                          userProfileId:
                                              widget!.userProfile?.reference.id,
                                      ...
                                      await widget!.userProfile!.reference
                                        ...
                                        ...mapToFirestore(
                                          {
                                            'permissionList':
                                                getUserAccesCListFirestoreData(
                                              functions.setPermission(
                                                  FFAppConstants.PermissionList
                                                      .toList(),
                                                  _model.dropDownRoleValue ==
                                                          'user'
                                                      ? 2
