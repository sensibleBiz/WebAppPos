...
import 'c_edit_premise_model.dart';
export 'c_edit_premise_model.dart';

class CEditPremiseWidget extends StatefulWidget {
  const CEditPremiseWidget({
    super.key,
    this.catRef,
  });
  ...
  @override
  State<CEditPremiseWidget> createState() => _CEditPremiseWidgetState();
}

class _CEditPremiseWidgetState extends State<CEditPremiseWidget> {
  late CEditPremiseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CEditPremiseModel());

    _model.textFieldPremiseNameFocusNode ??= FocusNode();

    _model.textFieldFocusNode ??= FocusNode();

    _model.textFieldNoOfTablesFocusNode ??= FocusNode();
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: StreamBuilder<PremisesRecord>(
              stream: PremisesRecord.getDocument(widget!.catRef!),
              builder: (context, snapshot) {
                ...
                final containerPremisesRecord = snapshot.data!;
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      controller: _model.textController2 ??=
                                          TextEditingController(
                                        text: containerPremisesRecord.code
                                            .toString(),
                                      ),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: FlutterFlowDropDown<String>(
                                controller: _model
                                        .dropDownPremisesTypeValueController ??=
                                    FormFieldController<String>(
                                  _model.dropDownPremisesTypeValue ??=
                                      containerPremisesRecord.type,
                                ),
                                options: ['Bill', 'Table', 'Room'],
                                onChanged: (val) => safeSetState(() =>
                                    _model.dropDownPremisesTypeValue = val),
                                width: 180.0,
                                height: 50.0,
                                  ...
                                  if (_model.textFieldPremiseNameTextController
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (alertDialogContext) {
                                        return WebViewAware(
                                          child: AlertDialog(
                                            title: Text('Update Premises '),
                                            content: Text(
                                                'Please Enter Premises Name,Table,Type,Range'),
                                            actions: [
                                              TextButton(
                                                onPressed: () => Navigator.pop(
                                                    alertDialogContext),
