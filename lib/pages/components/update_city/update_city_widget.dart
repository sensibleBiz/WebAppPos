...
import 'update_city_model.dart';
export 'update_city_model.dart';

class UpdateCityWidget extends StatefulWidget {
  ...
  @override
  State<UpdateCityWidget> createState() => _UpdateCityWidgetState();
}

class _UpdateCityWidgetState extends State<UpdateCityWidget> {
  late UpdateCityModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateCityModel());
        ...
        children: [
          Container(
            ...
            child: StreamBuilder<CitiesRecord>(
              stream: CitiesRecord.getDocument(widget!.docRef!),
              builder: (context, snapshot) {
                ...
                final containerCitiesRecord = snapshot.data!;
                          ...
                          child: Container(
                            ...
                            child: StreamBuilder<List<StateRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<StateRecord> dropDownStateRecordList =
                                    snapshot.data!;
                            ...
                            child: TextFormField(
                              controller:
                                  _model.textLanguageCodeTextController ??=
                                      TextEditingController(
                                text: containerCitiesRecord.code.toString(),
                              ),
