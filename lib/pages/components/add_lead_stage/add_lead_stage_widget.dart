...
import 'add_lead_stage_model.dart';
export 'add_lead_stage_model.dart';

class AddLeadStageWidget extends StatefulWidget {
  const AddLeadStageWidget({
    super.key,
    this.codeLen,
  });
  ...
  @override
  State<AddLeadStageWidget> createState() => _AddLeadStageWidgetState();
}

class _AddLeadStageWidgetState extends State<AddLeadStageWidget> {
  late AddLeadStageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddLeadStageModel());
                          ...
                          FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              final _colorPickedColor = await showFFColorPicker(
                                context,
                                currentColor:
                                    _model.colorPicked ?? Color(0xFFDF1E1E),
                              ...
                              _model.setColor = _model.colorPicked!;
                              safeSetState(() {});
                            },
                          ),
                          Container(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            if (_model.titleTextController.text != null &&
                              ...
                              var leadStagesRecordReference =
                                  LeadStagesRecord.createDoc(
