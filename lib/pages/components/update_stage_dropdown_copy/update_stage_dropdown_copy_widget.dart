...
import 'update_stage_dropdown_copy_model.dart';
export 'update_stage_dropdown_copy_model.dart';

class UpdateStageDropdownCopyWidget extends StatefulWidget {
  const UpdateStageDropdownCopyWidget({
    super.key,
    this.doc,
  });
  ...
  @override
  State<UpdateStageDropdownCopyWidget> createState() =>
      _UpdateStageDropdownCopyWidgetState();
}

class _UpdateStageDropdownCopyWidgetState
    extends State<UpdateStageDropdownCopyWidget> {
  late UpdateStageDropdownCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateStageDropdownCopyModel());
