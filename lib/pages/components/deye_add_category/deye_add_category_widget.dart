...
import 'deye_add_category_model.dart';
export 'deye_add_category_model.dart';

class DeyeAddCategoryWidget extends StatefulWidget {
  const DeyeAddCategoryWidget({
    super.key,
    this.codeLen,
  });
  ...
  @override
  State<DeyeAddCategoryWidget> createState() => _DeyeAddCategoryWidgetState();
}

class _DeyeAddCategoryWidgetState extends State<DeyeAddCategoryWidget> {
  late DeyeAddCategoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeyeAddCategoryModel());
