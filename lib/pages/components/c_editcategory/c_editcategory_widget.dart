...
import 'c_editcategory_model.dart';
export 'c_editcategory_model.dart';

class CEditcategoryWidget extends StatefulWidget {
  const CEditcategoryWidget({
    super.key,
    this.catRef,
  });
  ...
  @override
  State<CEditcategoryWidget> createState() => _CEditcategoryWidgetState();
}

class _CEditcategoryWidgetState extends State<CEditcategoryWidget> {
  late CEditcategoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CEditcategoryModel());
