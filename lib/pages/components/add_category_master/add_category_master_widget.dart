...
import 'add_category_master_model.dart';
export 'add_category_master_model.dart';
                                              ...
                                              onTap: () async {
                                                ...
                                                if (selectedMedia != null &&
                                                  ...
                                                  try {
                                                    ...
                                                    _model.isDataUploading_uploadDataO95 =
                                                        false;
                                                  }
                                                  if (selectedUploadedFiles
                                                      ...
                                                      downloadUrls.length ==
                                                          selectedMedia
                                                              .length) {
                                                    safeSetState(() {
                                                      _model.uploadedLocalFile_uploadDataO95 =
                                                          selectedUploadedFiles
                                                              .first;
                                                      _model.uploadedFileUrl_uploadDataO95 =
                                                          downloadUrls.first;
                                                    });
                                                  } else {
                                                    safeSetState(() {});
                                ...
                                child: Builder(
                                  builder: (context) {
                                    ...
                                    return SingleChildScrollView(
                                      child: Column(
                                        mainAxisSize: MainAxisSize.max,
                                        children: List.generate(list1.length,
                                            (list1Index) {
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              if (_model.textCategoryMasterTypeNameTextController
                                ...
                                if (!_model.dupCategoryMasterRef!) {
                                  ...
                                  await categoryMasterRecordReference
                                    ...
                                    regionalName:
                                        functions.jsonListToJsonString(
                                            FFAppState().names.toList()),
                                    ...
                                    builder: (alertDialogContext) {
                                      return WebViewAware(
                                        child: AlertDialog(
                                          title: Text('Create'),
                                          content: Text(
                                              'Category Master Add Successfully '),
                                          actions: [
                                            TextButton(
                                  ...
                                  await _model.doc!.reference
                                    ...
                                    id: functions
                                        .getDocIdFromDocRefCategoryMaster(
