...
import 'update_business_type_master_model.dart';
export 'update_business_type_master_model.dart';
...
class UpdateBusinessTypeMasterWidget extends StatefulWidget {
  ...
  final DocumentReference? subscriptionType;

  @override
  State<UpdateBusinessTypeMasterWidget> createState() =>
...
class _UpdateBusinessTypeMasterWidgetState
  ...
  late UpdateBusinessTypeMasterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateBusinessTypeMasterModel());
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child:
                                          ...
                                          stream:
                                              SubscriptionRecord.getDocument(
                                            ...
                                            return Container(
                                              ...
                                              child: StreamBuilder<
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  List<SubscriptionRecord>
                                                      dropDownSubscriptionTypeSubscriptionRecordList =
                                                      snapshot.data!;

                                                  return FlutterFlowDropDown<
                                                      String>(
                                                    controller: _model
                                                            .dropDownSubscriptionTypeValueController ??=
                                                        FormFieldController<
                                                            String>(
                                                      _model.dropDownSubscriptionTypeValue ??=
                                                  ...
                                                  if (_model.dropDownSubscriptionTypeValue ==
                                                    ...
                                                    StreamBuilder<
                                                      ...
                                                      builder:
                                                        ...
                                                        final textSubscriptionRecord =
                                                            snapshot.data!;

                                                        return Text(
                                                          textSubscriptionRecord
                                                              .amount
                                                              .toString(),
                        ...
                        StreamBuilder<List<SubscriptionRecord>>(
                          stream: querySubscriptionRecord(
                            queryBuilder: (subscriptionRecord) =>
                                subscriptionRecord.where(
                              'planName',
                              isEqualTo: _model.dropDownSubscriptionTypeValue,
                            ),
                            singleRecord: true,
                          ),
                          builder: (context, snapshot) {
                            ...
                            final rowSubscriptionRecord =
                                rowSubscriptionRecordList.isNotEmpty
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      if (_model.textBusinessTypeNameTextController
                                        ...
                                        await containerBusinessTypeRecord
                                            .reference
                                            .update(
                                          ...
                                          subscriptionRef:
                                              FFAppState().dropdown == true
                                                  ? rowSubscriptionRecord
                                                      ?.reference
                                                  : widget!.subscriptionType,
                                          imageUrl:
                                              'https://unsplash.com/photos/s5kTY-Ve1c0',
                                          createdBy: containerBusinessTypeRecord
                                              .createdBy,
                                        ));
                                        await showDialog(
                                          context: context,
                                          builder: (alertDialogContext) {
                                            return WebViewAware(
                                              child: AlertDialog(
                                                title: Text('Update'),
                                                content: Text(
                                                    'Successfully BusinessType is Updated'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () =>
                                                        Navigator.pop(
