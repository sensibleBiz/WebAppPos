                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                        CallLogsDashBoardWidget.routeName);
                                  },
                                  child: Container(
                                    width:
                                        MediaQuery.sizeOf(context).width * 1.0,
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    context.pushNamed(CDeviceWidget.routeName);
                                  },
                                  child: Container(
                                    width:
                                        MediaQuery.sizeOf(context).width * 1.0,
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                        SupportDashboardWidget.routeName);
                                  },
                                  child: Container(
                                    width: double.infinity,
                                    height: 44.0,
