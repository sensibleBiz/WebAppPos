...
import 'c_edit_user_model.dart';
export 'c_edit_user_model.dart';

class CEditUserWidget extends StatefulWidget {
  const CEditUserWidget({
    super.key,
    this.userRef,
    this.id,
  });
  ...
  @override
  State<CEditUserWidget> createState() => _CEditUserWidgetState();
}

class _CEditUserWidgetState extends State<CEditUserWidget> {
  late CEditUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CEditUserModel());
        ...
        children: [
          Container(
            ...
            child: StreamBuilder<UserProfileRecord>(
              stream: UserProfileRecord.getDocument(widget!.userRef!),
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      controller: _model.textController4 ??=
                                          TextEditingController(
                                        text:
                                            containerUserProfileRecord.quickPin,
                                      ),
