...
import 'dart:ui';
import 'schedule_dealer_activity_widget.dart' show ScheduleDealerActivityWidget;
...
class ScheduleDealerActivityModel
    extends FlutterFlowModel<ScheduleDealerActivityWidget> {
  ...
  DealerActivityRecord? activityDocCopy;
  DateTime? datePicked;
  // Stores action output result for [Backend Call - Create Document] action in Button widget.
  DealerActivityRecord? activityDoc;
