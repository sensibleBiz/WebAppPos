...
import 'c_add_premises_model.dart';
export 'c_add_premises_model.dart';

class CAddPremisesWidget extends StatefulWidget {
  const CAddPremisesWidget({
    super.key,
    this.codeLen,
  });
  ...
  @override
  State<CAddPremisesWidget> createState() => _CAddPremisesWidgetState();
}

class _CAddPremisesWidgetState extends State<CAddPremisesWidget> {
  late CAddPremisesModel _model;
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: FlutterFlowDropDown<String>(
                            controller:
                                _model.dropDownPremisesTypeValueController ??=
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              if (_model.textFieldPremisesNameTextController
                                ...
                                if (_model.dropDownPremisesTypeValue == null) {
                                  await showDialog(
                                    context: context,
                                    builder: (alertDialogContext) {
                                      return WebViewAware(
                                        child: AlertDialog(
                                          title: Text('Add Premise Type'),
                                          content: Text(
                                              'Please Select Premises Type'),
                                          actions: [
                                            TextButton(
                                ...
                                var premisesRecordReference =
                                    PremisesRecord.createDoc(
                                ...
                                await _model.catDoc!.reference
                                  ...
                                  id: functions.getDocIdFromDocRefPremises(
                                  ...
                                  builder: (alertDialogContext) {
                                    return WebViewAware(
                                      child: AlertDialog(
                                        ...
                                        content:
                                            Text('Premises Added Successfully'),
                                        actions: [
                                          TextButton(
                                            onPressed: () => Navigator.pop(
                                                alertDialogContext),
                                ...
                                context.pushNamed(CPremisesWidget.routeName);
                              } else {
                                if (_model.formKey.currentState == null ||
                                    !_model.formKey.currentState!.validate()) {
                                  return;
