...
import 'languages_copy_model.dart';
export 'languages_copy_model.dart';

class LanguagesCopyWidget extends StatefulWidget {
  const LanguagesCopyWidget({
    super.key,
    this.name,
    this.outletId,
  });
  ...
  static String routeName = 'LanguagesCopy';
  static String routePath = 'languagesCopy';

  @override
  State<LanguagesCopyWidget> createState() => _LanguagesCopyWidgetState();
}

class _LanguagesCopyWidgetState extends State<LanguagesCopyWidget> {
  late LanguagesCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LanguagesCopyModel());
                                                                                          ...
                                                                                          child: Column(
                                                                                            ...
                                                                                            children: [
                                                                                              Row(
                                                                                                ...
                                                                                                children: [
                                                                                                  Text(
                                                                                                    DateTime.fromMillisecondsSinceEpoch(listItem.createdDate).toString(),
                                                                                                    style: FlutterFlowTheme.of(context).titleMedium.override(
                                                                                                          fontFamily: FlutterFlowTheme.of(context).titleMediumFamily,
                                                                                                          letterSpacing: 0.0,
                                                                                                          useGoogleFonts: GoogleFonts.asMap().containsKey(FlutterFlowTheme.of(context).titleMediumFamily),
