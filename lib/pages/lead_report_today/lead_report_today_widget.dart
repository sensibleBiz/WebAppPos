...
import 'lead_report_today_model.dart';
export 'lead_report_today_model.dart';

class LeadReportTodayWidget extends StatefulWidget {
  const LeadReportTodayWidget({super.key});

  static String routeName = 'leadReportToday';
  static String routePath = 'leadReportToday';

  @override
  State<LeadReportTodayWidget> createState() => _LeadReportTodayWidgetState();
}

class _LeadReportTodayWidgetState extends State<LeadReportTodayWidget> {
  late LeadReportTodayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeadReportTodayModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.result1 = await actions.leadDocRefCopy(
                ...
                child: StreamBuilder<List<LeadsManagementRecord>>(
                  stream: queryLeadsManagementRecord(
                    ...
                    queryBuilder: (leadsManagementRecord) =>
                      ...
                      'date',
                      isEqualTo: FFAppState().dateForReport,
                    ),
                  ),
