...
import 'user_manual_admin_model.dart';
export 'user_manual_admin_model.dart';

class UserManualAdminWidget extends StatefulWidget {
  const UserManualAdminWidget({super.key});

  static String routeName = 'UserManualAdmin';
  static String routePath = 'userManualAdmin';

  @override
  State<UserManualAdminWidget> createState() => _UserManualAdminWidgetState();
}

class _UserManualAdminWidgetState extends State<UserManualAdminWidget> {
  late UserManualAdminModel _model;
