...
import '/index.dart';
import 'c_r_m_dashboard_n_e_w_widget.dart' show CRMDashboardNEWWidget;
...
class CRMDashboardNEWModel extends FlutterFlowModel<CRMDashboardNEWWidget> {
  ...
  // Stores action output result for [Custom Action - leadDocRefCopy] action in CRMDashboardNEW widget.
