...
import '/pages/components/add_tax/add_tax_widget.dart';
...
import '/pages/components/update_tax/update_tax_widget.dart';
import 'dart:ui';
...
import 'tax_master_model.dart';
export 'tax_master_model.dart';
...
class TaxMasterWidget extends StatefulWidget {
  ...
  static String routeName = 'TaxMaster';
  static String routePath = 'taxMaster';

  @override
  State<TaxMasterWidget> createState() => _TaxMasterWidgetState();
}

class _TaxMasterWidgetState extends State<TaxMasterWidget> {
  late TaxMasterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TaxMasterModel());
