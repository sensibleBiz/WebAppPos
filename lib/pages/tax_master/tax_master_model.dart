...
import '/index.dart';
import 'tax_master_widget.dart' show TaxMasterWidget;
...
class TaxMasterModel extends FlutterFlowModel<TaxMasterWidget> {
  ...
  // Stores action output result for [Custom Action - genarateTaxCode] action in Button widget.
  int? len;
