...
import 'email_login_new_not_in_use_model.dart';
export 'email_login_new_not_in_use_model.dart';

class EmailLoginNewNotInUseWidget extends StatefulWidget {
  const EmailLoginNewNotInUseWidget({super.key});

  static String routeName = 'EmailLoginNewNotInUse';
  static String routePath = 'emailLoginNewNotInUse';

  @override
  State<EmailLoginNewNotInUseWidget> createState() =>
      _EmailLoginNewNotInUseWidgetState();
}

class _EmailLoginNewNotInUseWidgetState
    extends State<EmailLoginNewNotInUseWidget> {
  late EmailLoginNewNotInUseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EmailLoginNewNotInUseModel());
