...
import '/index.dart';
import 'user_role_type_widget.dart' show UserRoleTypeWidget;
...
class UserRoleTypeModel extends FlutterFlowModel<UserRoleTypeWidget> {
  ...
  // Stores action output result for [Custom Action - genarateUserRoleCode] action in Button widget.
  int? len;
