...
import '/pages/components/add_subscription/add_subscription_widget.dart';
...
import '/pages/components/update_subscription/update_subscription_widget.dart';
import 'dart:ui';
                              ...
                              child: StreamBuilder<List<SubscriptionRecord>>(
                                stream: querySubscriptionRecord(
                                  queryBuilder: (subscriptionRecord) =>
                                      subscriptionRecord.orderBy('code',
                                          descending: true),
                                ),
                                                                                                    ...
                                                                                                    InkWell(
                                                                                                      ...
                                                                                                      onTap: () async {
                                                                                                        ...
                                                                                                        if (confirmDialogResponse) {
                                                                                                          await listItem.reference.update(createSubscriptionRecordData(
                                                                                                            status: false,
                                                                                                          ));
                                                                                                        } else {
                                                                                                          return;
                                                                                                  ...
                                                                                                  if (listItem.status == false)
                                                                                                    InkWell(
                                                                                                      ...
                                                                                                      onTap: () async {
                                                                                                        ...
                                                                                                        if (confirmDialogResponse) {
                                                                                                          await listItem.reference.update(createSubscriptionRecordData(
                                                                                                            status: functions.activeDevice(listItem.status),
                                                                                                          ));
                                                                                                        } else {
                                                                                                          return;
                                                                                                        }
                                                                                          ...
                                                                                          return WebViewAware(
                                                                                            child: GestureDetector(
                                                                                              ...
                                                                                              child: Padding(
                                                                                                ...
                                                                                                child: UpdateSubscriptionWidget(
                                                                                    ...
                                                                                    onTap: () async {
                                                                                      var confirmDialogResponse = await showDialog<bool>(
                                                                                            ...
                                                                                            builder: (alertDialogContext) {
                                                                                              return WebViewAware(
                                                                                                child: AlertDialog(
                                                                                                  title: Text('Delete Subscription Type'),
                                                                                                  content: Text('Are you sure ?'),
                                                                                                  actions: [
                                                                                                    TextButton(
                                                                                                      onPressed: () => Navigator.pop(alertDialogContext, false),
