...
import '/pages/components/add_contact_us/add_contact_us_widget.dart';
...
import 'contact_us_new_model.dart';
export 'contact_us_new_model.dart';

class ContactUsNewWidget extends StatefulWidget {
  const ContactUsNewWidget({super.key});

  static String routeName = 'ContactUsNew';
  static String routePath = 'contactUsNew';

  @override
  State<ContactUsNewWidget> createState() => _ContactUsNewWidgetState();
}

class _ContactUsNewWidgetState extends State<ContactUsNewWidget> {
  late ContactUsNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ContactUsNewModel());
