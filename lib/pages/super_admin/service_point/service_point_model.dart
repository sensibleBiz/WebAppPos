...
import '/index.dart';
import 'service_point_widget.dart' show ServicePointWidget;
...
class ServicePointModel extends FlutterFlowModel<ServicePointWidget> {
  ...
  // Stores action output result for [Custom Action - genarateServicePointCode] action in Button widget.
  int? len;
