...
import '/pages/components/add_sub_category_master/add_sub_category_master_widget.dart';
...
import '/pages/components/update_sub_category_master/update_sub_category_master_widget.dart';
import 'dart:ui';
...
import 'sub_category_master_model.dart';
export 'sub_category_master_model.dart';
...
class SubCategoryMasterWidget extends StatefulWidget {
  ...
  static String routeName = 'SubCategoryMaster';
  static String routePath = 'subCategoryMaster';

  @override
  State<SubCategoryMasterWidget> createState() =>
      _SubCategoryMasterWidgetState();
}

class _SubCategoryMasterWidgetState extends State<SubCategoryMasterWidget> {
  late SubCategoryMasterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SubCategoryMasterModel());
                                                                                                  ...
                                                                                                  child: InkWell(
                                                                                                    ...
                                                                                                    onTap: () async {
                                                                                                      ...
                                                                                                      if (confirmDialogResponse) {
                                                                                                        await listItem.reference.update(createSubCategoryRecordData(
                                                                                          ...
                                                                                          child: GestureDetector(
                                                                                            ...
                                                                                            child: Padding(
                                                                                              ...
                                                                                              child: UpdateSubCategoryMasterWidget(
                                                                                                ...
                                                                                                category: listItem.categoryMasterRef,
                                                                                              ),
                                                                                            ),
                                                                                          ),
                                                                                        );
