...
import '/index.dart';
import 'sub_category_master_widget.dart' show SubCategoryMasterWidget;
...
class SubCategoryMasterModel extends FlutterFlowModel<SubCategoryMasterWidget> {
  ...
  // Stores action output result for [Custom Action - genarateSubCatMasterCode] action in Button widget.
  int? len;
