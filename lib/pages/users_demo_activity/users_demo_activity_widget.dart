...
import 'users_demo_activity_model.dart';
export 'users_demo_activity_model.dart';

class UsersDemoActivityWidget extends StatefulWidget {
  const UsersDemoActivityWidget({super.key});

  static String routeName = 'UsersDemoActivity';
  static String routePath = 'usersDemoActivity';

  @override
  State<UsersDemoActivityWidget> createState() =>
      _UsersDemoActivityWidgetState();
}

class _UsersDemoActivityWidgetState extends State<UsersDemoActivityWidget> {
  late UsersDemoActivityModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UsersDemoActivityModel());
