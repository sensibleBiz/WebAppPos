...
import '/pages/components/upload_image_user_manual/upload_image_user_manual_widget.dart';
...
import 'user_manual_admin_copy_model.dart';
export 'user_manual_admin_copy_model.dart';

class UserManualAdminCopyWidget extends StatefulWidget {
  const UserManualAdminCopyWidget({super.key});

  static String routeName = 'UserManualAdminCopy';
  static String routePath = 'userManualAdminCopy';

  @override
  State<UserManualAdminCopyWidget> createState() =>
      _UserManualAdminCopyWidgetState();
}

class _UserManualAdminCopyWidgetState extends State<UserManualAdminCopyWidget> {
  late UserManualAdminCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserManualAdminCopyModel());
    ...
    _model.textController3 ??=
        TextEditingController(text: _model.headlineDropDownValue);
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child:
                                                ...
                                                controller: _model
                                                        .headlineDropDownValueController ??=
                                                ...
                                                onChanged: (val) async {
                                                  safeSetState(() => _model
                                                          .headlineDropDownValue =
                                                      val);
                                                  FFAppState().headerId = _model
                                                      .headlineDropDownValue!;
                                                  safeSetState(() {});
                                                  safeSetState(() {
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            FFAppState().removeAtIndexFromImgList(imglistIndex);
                                                                            safeSetState(() {});
                                                                          },
                                                                          child:
                                                                              Icon(
                                                                                  ...
                                                                                  return Dialog(
                                                                                    ...
                                                                                    child: WebViewAware(
                                                                                      child: GestureDetector(
                                                                                        ...
                                                                                        child: UploadImageUserManualWidget(),
                                                                                      ),
                                                                                    ),
                                                                                  );
                                                                                },
                                                                                    ...
                                                                                    children: [
                                                                                      Align(
                                                                                        ...
                                                                                        child: InkWell(
                                                                                          ...
                                                                                          highlightColor: Colors.transparent,
                                                                                          onTap: () async {
                                                                                            FFAppState().removeAtIndexFromSteps(valueOrDefault<int>(
                                                                                              listIndex,
                                                                                              0,
                                                                                            ));
                                                                                            safeSetState(() {});
                                ...
                                onPressed: () async {
                                  if (_model.headlineDropDownValue != null &&
                                    ...
                                    if (_model.textFieldTopicTextController
                                      ...
                                      await subHeaderRecordReference.set({
                                        ...createSubHeaderRecordData(
                                          topicName: _model
                                              .textFieldTopicTextController
                                              .text,
                                          videoURL: _model.textController6.text,
                                          headLine: _model.textController3.text,
                                          subHeadLine:
                                              _model.textController4.text,
                                          paragraph:
                                              _model.textController2.text,
                                          note: _model.textController7.text,
                                          headerID: FFAppState().headerId,
                                      ...
                                      }, subHeaderRecordReference);

                                      await _model.ref!.reference
                                          .update(createSubHeaderRecordData(
                                        id: _model.ref?.reference.id,
                                      ));
                                      await showDialog(
                                        context: context,
                                      ...
                                      safeSetState(() {
                                        ...
                                        _model.imgListTextController?.clear();
                                        _model.textController3?.clear();
                                        _model.textController2?.clear();
                                      });
                                      FFAppState().subHeaderId =
                                          _model.ref!.reference.id;
                                      FFAppState().subHeaderRef =
                                          _model.ref?.parentReference;
                                      FFAppState().steps = [];
                                      safeSetState(() {});
                                      ...
                                      builder: (alertDialogContext) {
                                        return WebViewAware(
                                          child: AlertDialog(
                                            title: Text('Failed'),
                                            content: Text(
                                                'Please select Header from dropdown'),
                                            actions: [
                                              TextButton(
