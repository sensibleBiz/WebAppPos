...
import 'lead_stages_master_model.dart';
export 'lead_stages_master_model.dart';

class LeadStagesMasterWidget extends StatefulWidget {
  const LeadStagesMasterWidget({super.key});

  static String routeName = 'LeadStagesMaster';
  static String routePath = 'leadStagesMaster';

  @override
  State<LeadStagesMasterWidget> createState() => _LeadStagesMasterWidgetState();
}

class _LeadStagesMasterWidgetState extends State<LeadStagesMasterWidget> {
  late LeadStagesMasterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeadStagesMasterModel());
