...
import 'q_r_login_model.dart';
export 'q_r_login_model.dart';

class QRLoginWidget extends StatefulWidget {
  const QRLoginWidget({super.key});

  static String routeName = 'QRLogin';
  static String routePath = 'qRLogin';
...
class _QRLoginWidgetState extends State<QRLoginWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QRLoginModel());
