...
import 'lead_status_master_new_model.dart';
export 'lead_status_master_new_model.dart';

class LeadStatusMasterNewWidget extends StatefulWidget {
  const LeadStatusMasterNewWidget({
    super.key,
    this.outletId,
  });
  ...
  static String routeName = 'LeadStatusMasterNew';
  static String routePath = 'LeadStatusMasterNew';

  @override
  State<LeadStatusMasterNewWidget> createState() =>
      _LeadStatusMasterNewWidgetState();
}

class _LeadStatusMasterNewWidgetState extends State<LeadStatusMasterNewWidget> {
  late LeadStatusMasterNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeadStatusMasterNewModel());
                        ...
                        child: StreamBuilder<List<LeadStatusRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<LeadStatusRecord>
                                containerLeadStatusRecordList = snapshot.data!;
