...
import 'c_complaint_report_model.dart';
export 'c_complaint_report_model.dart';

class CComplaintReportWidget extends StatefulWidget {
  const CComplaintReportWidget({super.key});

  static String routeName = 'cComplaintReport';
  static String routePath = 'cComplaintReport';

  @override
  State<CComplaintReportWidget> createState() => _CComplaintReportWidgetState();
}

class _CComplaintReportWidgetState extends State<CComplaintReportWidget> {
  late CComplaintReportModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CComplaintReportModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().filterDate = getCurrentTimestamp.toString();
      safeSetState(() {});
      FFAppState().filterDate = functions.getDayIdDate();
      safeSetState(() {});
    });
