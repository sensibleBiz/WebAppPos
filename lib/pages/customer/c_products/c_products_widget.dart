...
import 'c_products_model.dart';
export 'c_products_model.dart';

class CProductsWidget extends StatefulWidget {
  const CProductsWidget({
    super.key,
    this.outletId,
  });
  ...
  static String routeName = 'cProducts';
  static String routePath = 'cProducts';

  @override
  State<CProductsWidget> createState() => _CProductsWidgetState();
}

class _CProductsWidgetState extends State<CProductsWidget> {
  late CProductsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CProductsModel());
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        InkWell(
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            context.pushNamed(
                                                                              CEditProductDetailsNewWidget.routeName,
                                                                              queryParameters: {
