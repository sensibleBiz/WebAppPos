...
import 'c_category_model.dart';
export 'c_category_model.dart';

class CCategoryWidget extends StatefulWidget {
  const CCategoryWidget({
    super.key,
    this.outletId,
  });
  ...
  static String routePath = 'cCategory';

  @override
  State<CCategoryWidget> createState() => _CCategoryWidgetState();
}

class _CCategoryWidgetState extends State<CCategoryWidget> {
  late CCategoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CCategoryModel());
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Expanded(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Padding(
                                                                              padding: EdgeInsetsDirectional.fromSTEB(10.0, 0.0, 2.0, 0.0),
                                                                              child: Column(
                                                                                mainAxisSize: MainAxisSize.max,
