...
import 'c_user_account_model.dart';
export 'c_user_account_model.dart';

class CUserAccountWidget extends StatefulWidget {
  const CUserAccountWidget({
    super.key,
    this.outletId,
  });
  ...
  static String routeName = 'cUserAccount';
  static String routePath = 'cUserAccount';

  @override
  State<CUserAccountWidget> createState() => _CUserAccountWidgetState();
}

class _CUserAccountWidgetState extends State<CUserAccountWidget> {
  late CUserAccountModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CUserAccountModel());
                                                                                      ...
                                                                                      child: GestureDetector(
                                                                                        ...
                                                                                        child: Padding(
                                                                                          ...
                                                                                          child: Container(
                                                                                            ...
                                                                                            child: CEditUserWidget(
                                                                                              userRef: listItem.reference,
                                                                                              id: listItem.id,
                                                                                            ),
                                                                                          ),
                                                                                        ),
