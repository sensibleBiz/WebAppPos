...
import '/index.dart';
import 'business_type_master_widget.dart' show BusinessTypeMasterWidget;
...
class BusinessTypeMasterModel
    extends FlutterFlowModel<BusinessTypeMasterWidget> {
  ...
  // Stores action output result for [Custom Action - getLenthOfListBusinessTypeMaster] action in Button widget.
  int? len;
