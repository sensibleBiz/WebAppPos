...
import 'lead_employee_report_final_c_r_m_model.dart';
export 'lead_employee_report_final_c_r_m_model.dart';

class LeadEmployeeReportFinalCRMWidget extends StatefulWidget {
  const LeadEmployeeReportFinalCRMWidget({super.key});

  static String routeName = 'leadEmployeeReportFinalCRM';
  static String routePath = 'leadEmployeeReportFinalCRM';

  @override
  State<LeadEmployeeReportFinalCRMWidget> createState() =>
      _LeadEmployeeReportFinalCRMWidgetState();
}

class _LeadEmployeeReportFinalCRMWidgetState
    extends State<LeadEmployeeReportFinalCRMWidget> {
  late LeadEmployeeReportFinalCRMModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeadEmployeeReportFinalCRMModel());
  ...
  Widget build(BuildContext context) {
    ...
    return Title(
        title: 'leadEmployeeReportFinalCRM',
                                              ...
                                              child: SingleChildScrollView(
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Builder(
                                                      builder: (context) {
                                                        final userList = containerUserProfileRecordList
                                                            .where((e) => e
                                                                .permissionList
                                                                .where((e) =>
                                                                    (e.title ==
                                                                              ...
                                                                              builder: (context) {
                                                                                ...
                                                                                return Row(
                                                                                  ...
                                                                                  children: List.generate(listdata2.length, (listdata2Index) {
                                                                                    ...
                                                                                    return Expanded(
                                                                                      child: Text(
                                                                                        containerLeadsManagementRecordList.where((e) => (e.stage == listdata2Item.name) && (e.assignedTo == userListItem.id)).toList().length.toString(),
                                                                                        textAlign: TextAlign.center,
                                                                                        style: FlutterFlowTheme.of(context).labelLarge.override(
                                                                                              fontFamily: FlutterFlowTheme.of(context).labelLargeFamily,
                                                                                              letterSpacing: 0.0,
