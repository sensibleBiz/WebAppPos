...
import 'lead_report_monthly_model.dart';
export 'lead_report_monthly_model.dart';

class LeadReportMonthlyWidget extends StatefulWidget {
  const LeadReportMonthlyWidget({super.key});

  static String routeName = 'leadReportMonthly';
  static String routePath = 'leadReportMonthly';

  @override
  State<LeadReportMonthlyWidget> createState() =>
      _LeadReportMonthlyWidgetState();
}

class _LeadReportMonthlyWidgetState extends State<LeadReportMonthlyWidget> {
  late LeadReportMonthlyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeadReportMonthlyModel());
