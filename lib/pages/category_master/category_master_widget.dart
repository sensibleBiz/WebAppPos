...
import '/pages/components/add_category_master/add_category_master_widget.dart';
...
import '/pages/components/update_category_master/update_category_master_widget.dart';
import 'dart:ui';
...
import 'category_master_model.dart';
export 'category_master_model.dart';

class CategoryMasterWidget extends StatefulWidget {
  const CategoryMasterWidget({super.key});

  static String routeName = 'CategoryMaster';
  static String routePath = 'categoryMaster';

  @override
  State<CategoryMasterWidget> createState() => _CategoryMasterWidgetState();
}

class _CategoryMasterWidgetState extends State<CategoryMasterWidget> {
  late CategoryMasterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CategoryMasterModel());
                              ...
                              child: StreamBuilder<List<CategoryMasterRecord>>(
                                stream: queryCategoryMasterRecord(
                                  queryBuilder: (categoryMasterRecord) =>
                                      categoryMasterRecord.orderBy('code',
                                          descending: true),
                                ),
                                                                                              ...
                                                                                              InkWell(
                                                                                                ...
                                                                                                onTap: () async {
                                                                                                  ...
                                                                                                  if (confirmDialogResponse) {
                                                                                                    await listItem.reference.update(createCategoryMasterRecordData(
                                                                                        ...
                                                                                        return WebViewAware(
                                                                                          child: GestureDetector(
                                                                                            ...
                                                                                            child: Padding(
                                                                                              ...
                                                                                              child: UpdateCategoryMasterWidget(
