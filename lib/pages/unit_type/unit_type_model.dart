...
import '/index.dart';
import 'unit_type_widget.dart' show UnitTypeWidget;
...
class UnitTypeModel extends FlutterFlowModel<UnitTypeWidget> {
  ...
  // Stores action output result for [Custom Action - genarateUnitTypeCode] action in Button widget.
  int? len;
