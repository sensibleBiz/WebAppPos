...
import '/pages/components/add_unit_type/add_unit_type_widget.dart';
...
import '/pages/components/update_unit_type/update_unit_type_widget.dart';
import 'dart:ui';
...
class UnitTypeWidget extends StatefulWidget {
  ...
  static String routeName = 'UnitType';
  static String routePath = 'unitType';

  @override
  State<UnitTypeWidget> createState() => _UnitTypeWidgetState();
}

class _UnitTypeWidgetState extends State<UnitTypeWidget> {
  late UnitTypeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UnitTypeModel());
