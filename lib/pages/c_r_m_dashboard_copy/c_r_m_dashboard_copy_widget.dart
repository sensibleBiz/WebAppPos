...
import 'c_r_m_dashboard_copy_model.dart';
export 'c_r_m_dashboard_copy_model.dart';

class CRMDashboardCopyWidget extends StatefulWidget {
  const CRMDashboardCopyWidget({super.key});

  static String routeName = 'CRMDashboardCopy';
  static String routePath = 'CRMDashboard1';

  @override
  State<CRMDashboardCopyWidget> createState() => _CRMDashboardCopyWidgetState();
}

class _CRMDashboardCopyWidgetState extends State<CRMDashboardCopyWidget>
    with TickerProviderStateMixin {
  late CRMDashboardCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CRMDashboardCopyModel());
                                                                                  ...
                                                                                  child: Padding(
                                                                                    ...
                                                                                    child: StreamBuilder<List<LeadStagesRecord>>(
                                                                                      ...
                                                                                      builder: (context, snapshot) {
                                                                                        ...
                                                                                        List<LeadStagesRecord> dropDownStatusSLeadStagesRecordList = snapshot.data!;

                                                                                        return FlutterFlowDropDown<String>(
                                                                                          controller: _model.dropDownStatusSValueController ??= FormFieldController<String>(
                                                                                            _model.dropDownStatusSValue ??= '',
                                                                                          ),
                                                                                          options: List<String>.from(dropDownStatusSLeadStagesRecordList.map((e) => e.name).toList()),
                                                                                          optionLabels: dropDownStatusSLeadStagesRecordList.map((e) => e.display).toList(),
                                                                                          onChanged: (val) async {
