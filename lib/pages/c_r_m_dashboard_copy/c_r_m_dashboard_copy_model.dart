...
import '/index.dart';
import 'c_r_m_dashboard_copy_widget.dart' show CRMDashboardCopyWidget;
...
class CRMDashboardCopyModel extends FlutterFlowModel<CRMDashboardCopyWidget> {
  ...
  // Stores action output result for [Custom Action - leadDocRefCopy] action in CRMDashboardCopy widget.
  ...
  String? stage;
  // Stores action output result for [Custom Action - leadDocRefCopy] action in Text widget.
  List<dynamic>? res25;
