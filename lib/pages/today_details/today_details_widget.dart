...
import 'today_details_model.dart';
export 'today_details_model.dart';

class TodayDetailsWidget extends StatefulWidget {
  const TodayDetailsWidget({super.key});

  static String routeName = 'TodayDetails';
  static String routePath = 'todayDetails';

  @override
  State<TodayDetailsWidget> createState() => _TodayDetailsWidgetState();
}

class _TodayDetailsWidgetState extends State<TodayDetailsWidget>
    with TickerProviderStateMixin {
  late TodayDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TodayDetailsModel());
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        context.pushNamed(
                                            TodayDetailsCopyWidget.routeName);
                                      },
                                      child: Text(
                                        'Today\'s Details',
                                                                  ...
                                                                  children: [
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            listViewLeadFollowUpRecord.followUpName,
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              listViewLeadFollowUpRecord.mobile,
                                                                          ...
                                                                          Row(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Padding(
                                                                                padding: EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 25.0, 0.0),
                                                                                child: Text(
                                                                                  dateTimeFormat("jms", DateTime.fromMillisecondsSinceEpoch(listViewLeadFollowUpRecord.time)),
                                                                                  style: FlutterFlowTheme.of(context).labelSmall.override(
                                                                                        fontFamily: FlutterFlowTheme.of(context).labelSmallFamily,
                                                                                        letterSpacing: 0.0,
                                                                                        useGoogleFonts: !FlutterFlowTheme.of(context).labelSmallIsCustom,
                                                                                  ...
                                                                                  child: StreamBuilder<List<UserProfileRecord>>(
                                                                                    stream: queryUserProfileRecord(
                                                                                      queryBuilder: (userProfileRecord) => userProfileRecord.where(
                                                                                        'id',
                                                                                        isEqualTo: listViewLeadFollowUpRecord.assignedTo,
                                                                                      ),
                                                                                      singleRecord: true,
                                                                                    ),
                                                                                    builder: (context, snapshot) {
