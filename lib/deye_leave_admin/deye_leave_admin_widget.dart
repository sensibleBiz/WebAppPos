  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<LeaveApplicationRecord>>(
      stream: queryLeaveApplicationRecord(
        ...
        queryBuilder: (leaveApplicationRecord) => leaveApplicationRecord.where(
          'monthId',
      ...
      builder: (context, snapshot) {
        ...
        List<LeaveApplicationRecord> deyeLeaveAdminLeaveApplicationRecordList =
            snapshot.data!;
                        ...
                        stream: queryTeamTreeRecord(
                          ...
                          queryBuilder: (teamTreeRecord) => teamTreeRecord
                              ...
                              .whereArrayContainsAny(
                                  'zoneList', FFAppState().currentUserZoneList)
                              .where(
                                'onRole',
                                isEqualTo: true,
                              ),
                                                                  ...
                                                                  functions
                                                                      .getZonewise(
                                                                          deyeLeaveAdminLeaveApplicationRecordList
                                                                              .where((e) => (e.fromDate <= functions.getTodayDateInMili(_model.selectedDate!)) && (e.status == 'APPROVED') && (e.toDate == functions.getTodayDateInMili(getCurrentTimestamp)))
                                                                              .toList(),
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      final requestedList = functions
                                                                          .getZonewiseLeave(
                                                                              deyeLeaveAdminLeaveApplicationRecordList.where((e) => e.status == 'REQUESTED').toList(),
                                                                              containerTeamTreeRecordList.toList())
                                                                          .toList();
                                                                      if (requestedList
                                                                          .isEmpty) {
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      final approvedList = functions
                                                                          .getZonewiseLeave(
                                                                              deyeLeaveAdminLeaveApplicationRecordList.where((e) => e.status == 'APPROVED').toList(),
                                                                              containerTeamTreeRecordList.toList())
                                                                          .toList();
                                                                      if (approvedList
                                                                          .isEmpty) {
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      final rejectedList = functions
                                                                          .getZonewiseLeave(
                                                                              deyeLeaveAdminLeaveApplicationRecordList.where((e) => e.status == 'REJECTED').toList(),
                                                                              containerTeamTreeRecordList.toList())
                                                                          .toList();
                                                                      if (rejectedList
                                                                          .isEmpty) {
