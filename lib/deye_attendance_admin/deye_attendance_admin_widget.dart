...
import 'deye_attendance_admin_model.dart';
export 'deye_attendance_admin_model.dart';

class DeyeAttendanceAdminWidget extends StatefulWidget {
  const DeyeAttendanceAdminWidget({super.key});

  static String routeName = 'DeyeAttendanceAdmin';
  static String routePath = 'deyeAttendanceAdmin';

  @override
  State<DeyeAttendanceAdminWidget> createState() =>
      _DeyeAttendanceAdminWidgetState();
}

class _DeyeAttendanceAdminWidgetState extends State<DeyeAttendanceAdminWidget> {
  late DeyeAttendanceAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeyeAttendanceAdminModel());
      ...
      builder: (context) => StreamBuilder<List<LeaveApplicationRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<LeaveApplicationRecord>
              deyeAttendanceAdminLeaveApplicationRecordList = snapshot.data!;

          return Title(
              title: 'DeyeAttendanceAdmin',
                                                                      ...
                                                                      functions.checkAbsentCount(
                                                                          ...
                                                                          containerAttendanceRecordList
                                                                              .where((e) =>
                                                                                  ...
                                                                                  0)
                                                                              .toList(),
                                                                          deyeAttendanceAdminLeaveApplicationRecordList
                                                                              .where((e) => e.toDate == functions.getTodayDateInMili(getCurrentTimestamp))
                                                                              .toList()),
                                                                      '0',
                                                                    ),
                                                                    style: FlutterFlowTheme.of(
                                                                    ...
                                                                    FlutterFlowIconButton(
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        final _datePickedDate =
                                                                          ...
                                                                          builder:
                                                                            ...
                                                                            return wrapInMaterialDatePickerTheme(
                                                                              ...
                                                                              selectedDateTimeBackgroundColor: FlutterFlowTheme.of(context).primaryBackground,
                                                                        ...
                                                                        _model.attendanceDayId =
                                                                            functions.selectedDayId(_model.datePicked!);
                                                                        _model.selectedDate =
                                                                            _model.datePicked;
                                                                        safeSetState(
                                                                            () {});
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        _model.base64Link232Current =
                                                                            await actions.downloadAttendence(
                                                                          _model
                                                                        ...
                                                                        if ((_model.apiResult88gCurrent?.succeeded ??
                                                                            true)) {
                                                                          await showDialog(
                                                                            context:
                                                                                context,
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        if ((_model.apiResult88gLast?.succeeded ??
                                                                            true)) {
                                                                          await showDialog(
                                                                            context:
                                                                                context,
                                                                ...
                                                                child: Builder(
                                                                  builder:
                                                                    ...
                                                                    final presentList = functions
                                                                        .getZonewiseAtt(
                                                                            containerAttendanceRecordList.where((e) => e.checkInTime > 0).toList().sortedList(keyOf: (e) => e.checkInTime, desc: true).toList(),
                                                                            containerTeamTreeRecordList.toList())
                                                                        .toList();
                                                                    if (presentList
                                                                        .isEmpty) {
                                                                                ...
                                                                                children: [
                                                                                  Row(
                                                                                    ...
                                                                                    children: [
                                                                                      ...
                                                                                      Expanded(
                                                                                        child: Builder(
                                                                                          builder: (context) => StreamBuilder<List<UserProfileRecord>>(
                                                                                            ...
                                                                                            builder: (context, snapshot) {
                                                                                              ...
                                                                                              return InkWell(
                                                                                                ...
                                                                                                onTap: () async {
                                                                                                  ...
                                                                                                  _model.allAttendence1Copy = await queryAttendanceRecordOnce(
                                                                                                    parent: FFAppState().outletRef,
                                                                                                    queryBuilder: (attendanceRecord) => attendanceRecord
                                                                                                        .where(
                                                                                                          'createdDate',
                                                                                                  ...
                                                                                                  _model.base64Link2321Copy = await actions.genExcelForEmployeeAttendanceReport(
                                                                                                    _model.allAttendence1Copy!.toList(),
                                                                                                    FFAppState().outletRef!.id,
                                                                                                    textUserProfileRecord!.reference.id,
                                                                                                  );
                                                                                                  _model.apiResult88g1Copy = await SendMailCall.call(
                                                                                                    mobileNo: FFAppState().currentMobile,
                                                                                                    outletName: '',
                                                                                                    file: _model.base64Link2321Copy,
                                                                                                  ...
                                                                                                  if ((_model.apiResult88g1Copy?.succeeded ?? true)) {
                                                                                                    await showDialog(
                                                                                                      context: context,
                                                                                ...
                                                                                Builder(
                                                                                  builder: (context) => InkWell(
                                                                                    ...
                                                                                    onTap: () async {
                                                                                      ...
                                                                                      _model.allAttendence1Copy2 = await queryAttendanceRecordOnce(
                                                                                        parent: FFAppState().outletRef,
                                                                                        queryBuilder: (attendanceRecord) => attendanceRecord
                                                                                            .where(
                                                                                              'createdDate',
                                                                                      ...
                                                                                      _model.base64Link2321Copy2 = await actions.genExcelForEmployeeAttendanceReport(
                                                                                        _model.allAttendence1Copy2!.toList(),
                                                                                        FFAppState().outletRef!.id,
                                                                                        absentListItem.userProfileId,
                                                                                      );
                                                                                      _model.apiResult88g1Copy2 = await SendMailCall.call(
                                                                                        mobileNo: FFAppState().currentMobile,
                                                                                        outletName: '',
                                                                                        file: _model.base64Link2321Copy2,
                                                                                        fileName: 'AttendanceReport',
                                                                                        toEmail: FFAppState().emailForReport,
                                                                                        branchName: '',
                                                                                        username: valueOrDefault(currentUserDocument?.name, ''),
                                                                                      ...
                                                                                      if ((_model.apiResult88g1Copy2?.succeeded ?? true)) {
                                                                                        await showDialog(
                                                                                          context: context,
                                                                                          builder: (alertDialogContext) {
                                                                                            return WebViewAware(
