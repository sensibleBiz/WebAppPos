                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        CircularPercentIndicator(
                                                                          percent: functions.subscriptionDaysProgress(
                                                                              deyeSubscriptionOutletRecord!.createdDate,
                                                                              deyeSubscriptionOutletRecord!.renewalDate),
                                                                          radius:
                                                                              35.0,
                                                                          lineWidth:
                                                              ...
                                                              queryBuilder:
                                                                  (subscriptionRecord) =>
                                                                      subscriptionRecord
                                                                          .where(
                                                                'id',
                                                                isEqualTo: functions.getDocIdFromDocRefSubscriptionType(containerBusinessTypeRecord
                                                                            .subscriptionRef) !=
                                                                        ''
