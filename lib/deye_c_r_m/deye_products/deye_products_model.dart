...
import '/index.dart';
import 'deye_products_widget.dart' show DeyeProductsWidget;
...
class DeyeProductsModel extends FlutterFlowModel<DeyeProductsWidget> {
  ///  State fields for stateful widgets in this page.

  // Model for DeyeHeader component.
  late DeyeHeaderModel deyeHeaderModel;
  // Stores action output result for [Custom Action - generateProducTCode] action in Button widget.
  int? len;
