...
import 'deye_edit_product_model.dart';
export 'deye_edit_product_model.dart';

class DeyeEditProductWidget extends StatefulWidget {
  const DeyeEditProductWidget({
    super.key,
    this.productDoc,
  });
  ...
  @override
  State<DeyeEditProductWidget> createState() => _DeyeEditProductWidgetState();
}

class _DeyeEditProductWidgetState extends State<DeyeEditProductWidget> {
  late DeyeEditProductModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeyeEditProductModel());
    ...
    _model.categoryNoTextController ??=
        TextEditingController(text: widget!.productDoc?.code?.toString());
                  ...
                  children: [
                    Expanded(
                      child: TextFormField(
                        ...
                        validator: _model.categoryNoTextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                  ],
                  ...
                  builder: (context, snapshot) {
                    ...
                    return FlutterFlowDropDown<String>(
                      controller: _model.dropDownValueController ??=
                        ...
                        _model.dropDownValue ??= widget!.productDoc?.id,
                      ),
                      options: List<String>.from(
                          dropDownCategoryRecordList.map((e) => e.id).toList()),
                        ...
                        onTap: () async {
                          if (_model.textFieldNameTextController.text != null &&
                            ...
                            await widget!.productDoc!.reference
                              ...
                              category: _model.dropDownValue != null &&
                                      _model.dropDownValue != ''
                                  ? _model.dropDownValue
                                  : widget!.productDoc?.category,
                            ));
                            await showDialog(
                              context: context,
