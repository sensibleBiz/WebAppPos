...
import 'deye_city_wise_report_model.dart';
export 'deye_city_wise_report_model.dart';

class DeyeCityWiseReportWidget extends StatefulWidget {
  const DeyeCityWiseReportWidget({super.key});

  static String routeName = 'DeyeCityWiseReport';
  static String routePath = 'deyeCityWiseReport';

  @override
  State<DeyeCityWiseReportWidget> createState() =>
      _DeyeCityWiseReportWidgetState();
}

class _DeyeCityWiseReportWidgetState extends State<DeyeCityWiseReportWidget> {
  late DeyeCityWiseReportModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeyeCityWiseReportModel());
                                                                    ...
                                                                    Expanded(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        builder:
                                                                            (context) {
                                                                          final listdata2 =
                                                                              containerLeadStagesRecordList.toList();
                                                                          ...
                                                                          return Row(
                                                                            ...
                                                                            children:
                                                                                List.generate(listdata2.length, (listdata2Index) {
