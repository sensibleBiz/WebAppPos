...
import 'deye_dashboard_e_x_p_a_n_d_model.dart';
export 'deye_dashboard_e_x_p_a_n_d_model.dart';

class DeyeDashboardEXPANDWidget extends StatefulWidget {
  const DeyeDashboardEXPANDWidget({super.key});

  static String routeName = 'DeyeDashboardEXPAND';
  static String routePath = 'Dashboard';

  @override
  State<DeyeDashboardEXPANDWidget> createState() =>
      _DeyeDashboardEXPANDWidgetState();
}

class _DeyeDashboardEXPANDWidgetState extends State<DeyeDashboardEXPANDWidget>
    with TickerProviderStateMixin {
  late DeyeDashboardEXPANDModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeyeDashboardEXPANDModel());
