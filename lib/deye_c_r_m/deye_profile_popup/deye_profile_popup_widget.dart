    ...
    return StreamBuilder<List<TeamTreeRecord>>(
      stream: queryTeamTreeRecord(
        ...
        queryBuilder: (teamTreeRecord) => teamTreeRecord.where(
          'userProfileId',
          isEqualTo: widget!.profileDoc?.id,
        ),
        singleRecord: true,
      ),
      builder: (context, snapshot) {
        ...
        final containerTeamTreeRecord = containerTeamTreeRecordList.isNotEmpty
                    ...
                    FlutterFlowDropDown<String>(
                      controller: _model.dropDownValueController ??=
                        ...
                        _model.dropDownValue ??=
                            containerTeamTreeRecord?.workMode,
                      ),
                      options: ['AVAILABLE', 'BUSY', 'NOT_AVAILABLE'],
                      onChanged: (val) async {
                        safeSetState(() => _model.dropDownValue = val);
                        await containerTeamTreeRecord!.reference
                            .update(createTeamTreeRecordData(
                          workMode: _model.dropDownValue,
                        ));
                      },
                      width: 200.0,
                      height: 40.0,
