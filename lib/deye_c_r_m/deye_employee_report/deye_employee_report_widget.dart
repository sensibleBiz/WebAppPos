                                                              ...
                                                              child: Builder(
                                                                builder:
                                                                  ...
                                                                  final userList = functions
                                                                      .getComplaintSortedArray(
                                                                          containerLeadsManagementRecordList
                                                                              .toList(),
                                                                          (_model.dropDownZoneAllValue == null || _model.dropDownZoneAllValue == '' ? containerTeamTreeRecordList : containerTeamTreeRecordList.where((e) => e.userProfileId == _model.dropDownZoneAllValue).toList())
                                                                              .toList())
                                                                      .toList();
