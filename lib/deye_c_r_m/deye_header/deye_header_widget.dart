...
class _DeyeHeaderWidgetState extends State<DeyeHeaderWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<OutletRecord>(
      stream: FFAppState().renewalDateQuery(
        requestFn: () => OutletRecord.getDocument(FFAppState().outletRef!),
      ),
                                ...
                                stream: queryLeadsManagementRecord(
                                  ...
                                  queryBuilder: (leadsManagementRecord) =>
                                      leadsManagementRecord
                                          ...
                                          .whereIn('stage', _model.stageList)
                                          .orderBy('updatedDate',
                                              descending: true),
                                ),
                                builder: (context, snapshot) {
