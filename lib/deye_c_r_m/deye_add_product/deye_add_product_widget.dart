...
import 'deye_add_product_model.dart';
export 'deye_add_product_model.dart';

class DeyeAddProductWidget extends StatefulWidget {
  const DeyeAddProductWidget({
    super.key,
    this.len,
  });
  ...
  @override
  State<DeyeAddProductWidget> createState() => _DeyeAddProductWidgetState();
}

class _DeyeAddProductWidgetState extends State<DeyeAddProductWidget> {
  late DeyeAddProductModel _model;
                          ...
                          if (_model.textFieldNameTextController.text != null &&
                            ...
                            await productRecordReference
                              ...
                              categoryRef: functions.getCatDocRefFroMId(
                                  _model.dropDownValue, FFAppState().outletRef),
                              type: 0,
                            ));
                            _model.productDoc =
                            ...
                            await _model.productDoc!.reference
                                .update(createProductRecordData(
                              id: _model.productDoc?.reference.id,
                            ));
                            await showDialog(
                              context: context,
