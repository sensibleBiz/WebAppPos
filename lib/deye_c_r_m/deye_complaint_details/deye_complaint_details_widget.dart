...
import 'deye_complaint_details_model.dart';
export 'deye_complaint_details_model.dart';

class DeyeComplaintDetailsWidget extends StatefulWidget {
  const DeyeComplaintDetailsWidget({
    super.key,
    this.mobile,
  ...
  static String routeName = 'DeyeComplaintDetails';
  static String routePath = 'deyeComplaintDetails';

  @override
  State<DeyeComplaintDetailsWidget> createState() =>
      _DeyeComplaintDetailsWidgetState();
}

class _DeyeComplaintDetailsWidgetState extends State<DeyeComplaintDetailsWidget>
    with TickerProviderStateMixin {
  late DeyeComplaintDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeyeComplaintDetailsModel());
                                                                  ...
                                                                  options: List<
                                                                      ...
                                                                      dropDownProductNameCategoryRecordList
                                                                          .map((e) =>
                                                                              e.id)
                                                                          .toList()),
                                                                  optionLabels: dropDownProductNameCategoryRecordList
                                                                      .map((e) =>
                                                                          e.name)
                                                                      .toList(),
                                                                  onChanged: (val) =>
                                                              ...
                                                              return FlutterFlowDropDown<
                                                                ...
                                                                controller: _model
                                                                    ...
                                                                    FormFieldController<
                                                                            String>(
                                                                        null),
                                                                options: dropDownProductionCapacityProductRecordList
                                                                    .map((e) =>
                                                                        e.name)
                                                                    .toList(),
                                                                onChanged: (val) =>
