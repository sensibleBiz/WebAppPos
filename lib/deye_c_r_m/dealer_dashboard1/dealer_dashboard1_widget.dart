...
import 'dealer_dashboard1_model.dart';
export 'dealer_dashboard1_model.dart';

class DealerDashboard1Widget extends StatefulWidget {
  const DealerDashboard1Widget({super.key});

  static String routeName = 'DealerDashboard1';
  static String routePath = 'dealerDashboard1';

  @override
  State<DealerDashboard1Widget> createState() => _DealerDashboard1WidgetState();
}

class _DealerDashboard1WidgetState extends State<DealerDashboard1Widget> {
  late DealerDashboard1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DealerDashboard1Model());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().isOnboard = false;
      FFAppState().leadCreateValue = 'NEW';
      safeSetState(() {});
                    ...
                    stream: FFAppState().dealers(
                      requestFn: () => queryDealersRecord(
                        ...
                        queryBuilder: (dealersRecord) =>
                            dealersRecord.orderBy('dealerName'),
                      ),
                    ),
                                                                ...
                                                                return Dialog(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                          DealerActivityViewWidget(
                                                                        id: leadListItem
                                                                            .id,
                                                                        dealerName:
                                                                            leadListItem.dealerName,
                                                                      ),
                                                                    ),
                                                                  ),
                                                                );
                                                                                    ...
                                                                                    return Dialog(
                                                                                      ...
                                                                                      child: WebViewAware(
                                                                                        child: GestureDetector(
                                                                                          ...
                                                                                          child: UpdateDelaerStatusWidget(
                                                                                            dealerDoc: leadListItem,
                                                                                          ),
                                                                                        ),
                                                                                      ),
                                                                                    );
