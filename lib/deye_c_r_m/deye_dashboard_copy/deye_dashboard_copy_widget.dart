...
import 'deye_dashboard_copy_model.dart';
export 'deye_dashboard_copy_model.dart';

class DeyeDashboardCopyWidget extends StatefulWidget {
  const DeyeDashboardCopyWidget({super.key});

  static String routeName = 'DeyeDashboardCopy';
  static String routePath = 'Dashboardcopy';

  @override
  State<DeyeDashboardCopyWidget> createState() =>
      _DeyeDashboardCopyWidgetState();
}

class _DeyeDashboardCopyWidgetState extends State<DeyeDashboardCopyWidget>
    with TickerProviderStateMixin {
  late DeyeDashboardCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeyeDashboardCopyModel());
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        final containerVar = (_model.isSearched
                                                                                ? functions.filteredNewComplaints(containerOutletLeadsRecordList.toList(), _model.textController.text, _model.dropDownValue == null || _model.dropDownValue == '' ? '' : _model.dropDownValue!)
                                                                                : containerOutletLeadsRecordList)
                                                                            .toList();
                                                                        if (containerVar
                                                                            .isEmpty) {
