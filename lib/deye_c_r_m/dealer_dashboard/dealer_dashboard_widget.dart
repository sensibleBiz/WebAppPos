...
import 'dealer_dashboard_model.dart';
export 'dealer_dashboard_model.dart';

class DealerDashboardWidget extends StatefulWidget {
  const DealerDashboardWidget({super.key});

  static String routeName = 'DealerDashboard';
  static String routePath = 'dealerDashboard';
...
class _DealerDashboardWidgetState extends State<DealerDashboardWidget> {
  late DealerDashboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DealerDashboardModel());
