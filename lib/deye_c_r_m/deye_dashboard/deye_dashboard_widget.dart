                                                                        ...
                                                                        child:
                                                                          ...
                                                                          decoration:
                                                                            ...
                                                                            color:
                                                                              ...
                                                                              } else if (listViewLeadStagesRecord.name == 'pending') {
                                                                  ...
                                                                  StreamBuilder<
                                                                    ...
                                                                    stream:
                                                                      ...
                                                                      queryBuilder: (teamTreeRecord) => teamTreeRecord
                                                                          .whereIn(
                                                                              'zone',
                                                                              FFAppState().currentUserZoneList != '' ? FFAppState().currentUserZoneList : null)
                                                                          .orderBy('userName'),
                                                                    ),
                                                                    builder:
                                                                        (context,
                                                                      ...
                                                                      return FlutterFlowDropDown<
                                                                          String>(
                                                                        controller:
                                                                            _model.dropDownAssignedValueController ??=
                                                                    ...
                                                                    return Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        builder:
                                                                            (context) {
                                                                          final containerVar =
                                                                              (_model.isSearched ? functions.filteredNewComplaints(containerNewTabOutletLeadsRecordList.toList(), _model.textController.text, _model.dropDownValue == null || _model.dropDownValue == '' ? '' : _model.dropDownValue!) : containerNewTabOutletLeadsRecordList).toList();
                                                                          if (containerVar
                                                                              .isEmpty) {
                                                                            return Center(
                                                                              child: Container(
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      final containerVarMng = _model
                                                                          ...
                                                                          ? functions.filteredComplaints(
                                                                              ...
                                                                              _model.switchValue!)
                                                                          : containerLeadsManagementRecordList.where((e) => e.stage == FFAppState().leadCreateValue).toList().sortedList(keyOf: (e) => e.createdDate, desc: true).toList();
                                                                      if (containerVarMng
                                                                          .isEmpty) {
                                                                        return Container(
                                                                          width:
                                                                                          ...
                                                                                          children: [
                                                                                            ...
                                                                                            Row(
                                                                                              ...
                                                                                              children: [
                                                                                                ...
                                                                                                if (FFAppState().leadCreateValue == 'completed')
                                                                                                  Text(
                                                                                                    'Resolution Duration: ${functions.calculateComplaintResolutionDuration(containerVarMngItem.createdDate, containerVarMngItem.closeDateMili)}',
                                                                    ...
                                                                    child: StreamBuilder<
                                                                      ...
                                                                      stream:
                                                                        ...
                                                                        queryBuilder: (leadActivitiesRecord) => leadActivitiesRecord
                                                                            .where(
                                                                              'scheduledDate',
                                                                              isGreaterThanOrEqualTo: functions.yesterdayCopy(),
                                                                            )
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        final list = functions
                                                                            .groupLeadByExcecutive(containerLeadsManagementRecordList.toList())
                                                                            .toList()
                                                                            .take(5)
                                                                            .toList();
