...
import 'deye_lead_status_master_model.dart';
export 'deye_lead_status_master_model.dart';

class DeyeLeadStatusMasterWidget extends StatefulWidget {
  const DeyeLeadStatusMasterWidget({
    super.key,
    this.outletId,
  });
  ...
  static String routeName = 'DeyeLeadStatusMaster';
  static String routePath = 'DeyeLeadStatusMaster';

  @override
  State<DeyeLeadStatusMasterWidget> createState() =>
      _DeyeLeadStatusMasterWidgetState();
}

class _DeyeLeadStatusMasterWidgetState
    extends State<DeyeLeadStatusMasterWidget> {
  late DeyeLeadStatusMasterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeyeLeadStatusMasterModel());
                ...
                Expanded(
                  ...
                  child: StreamBuilder<List<LeadStatusRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<LeadStatusRecord> containerLeadStatusRecordList =
                          snapshot.data!;
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        _model.len =
                                            await actions.generateLeadStatus(
