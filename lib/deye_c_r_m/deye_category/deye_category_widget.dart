...
import 'deye_category_model.dart';
export 'deye_category_model.dart';

class DeyeCategoryWidget extends StatefulWidget {
  const DeyeCategoryWidget({
    super.key,
    this.outletId,
  });
  ...
  static String routeName = 'DeyeCategory';
  static String routePath = 'deyeCategory';

  @override
  State<DeyeCategoryWidget> createState() => _DeyeCategoryWidgetState();
}

class _DeyeCategoryWidgetState extends State<DeyeCategoryWidget> {
  late DeyeCategoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeyeCategoryModel());
