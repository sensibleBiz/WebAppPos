...
import 'deye_team_tree3_model.dart';
export 'deye_team_tree3_model.dart';

class DeyeTeamTree3Widget extends StatefulWidget {
  const DeyeTeamTree3Widget({super.key});

  static String routeName = 'DeyeTeamTree3';
  static String routePath = 'deyeTeamTree3';

  @override
  State<DeyeTeamTree3Widget> createState() => _DeyeTeamTree3WidgetState();
}

class _DeyeTeamTree3WidgetState extends State<DeyeTeamTree3Widget> {
  late DeyeTeamTree3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeyeTeamTree3Model());
                                                            ...
                                                            children: [
                                                              ...
                                                              Expanded(
                                                                child: Builder(
                                                                  builder:
                                                                      (context) {
                                                                    final serviceEng = containerTeamTreeRecordList
                                                                        .where((e) =>
                                                                            (e.roleInZone ==
                                                                                'user') &&
                                                                            (e.teamHeadProfileId ==
                                                                                listMItem.userProfileId))
                                                                        .toList();
                                                                    if (serviceEng
                                                                        .isEmpty) {
                                                                      return ListViewMsgWidget();
                                                                    ...
                                                                    return GridView
                                                                      ...
                                                                      itemBuilder:
                                                                          (context,
                                                                              serviceEngIndex) {
                                                                        final serviceEngItem =
                                                                            serviceEng[serviceEngIndex];
                                                                        return Container(
                                                                          decoration:
                                                                              BoxDecoration(),
                                                                          child:
