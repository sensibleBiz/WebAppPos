...
import 'all_user_account_model.dart';
export 'all_user_account_model.dart';

class AllUserAccountWidget extends StatefulWidget {
  const AllUserAccountWidget({
    super.key,
    this.outletId,
  });
  ...
  static String routeName = 'AllUserAccount';
  static String routePath = 'allUserAccount';

  @override
  State<AllUserAccountWidget> createState() => _AllUserAccountWidgetState();
}

class _AllUserAccountWidgetState extends State<AllUserAccountWidget> {
  late AllUserAccountModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllUserAccountModel());
                        ...
                        child: StreamBuilder<List<UserProfileRecord>>(
                          stream: queryUserProfileRecord(
                            queryBuilder: (userProfileRecord) =>
                                userProfileRecord.orderBy('name'),
                          ),
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                              ...
                                                                              if (confirmDialogResponse) {
                                                                                await listItem.reference.update(createUserProfileRecordData(
                                                                                  isDeleted: true,
                                                                                ));
                                                                                  ...
                                                                                  InkWell(
                                                                                    ...
                                                                                    onTap: () async {
                                                                                      ...
                                                                                      if (confirmDialogResponse) {
                                                                                        ...
                                                                                        context.pushNamed(
                                                                                          AllUserAccountWidget.routeName,
                                                                                          queryParameters: {
