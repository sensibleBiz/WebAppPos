...
import 'deye_dashboard_not_using_model.dart';
export 'deye_dashboard_not_using_model.dart';

class DeyeDashboardNotUsingWidget extends StatefulWidget {
  const DeyeDashboardNotUsingWidget({super.key});

  static String routeName = 'DeyeDashboardNotUsing';
  static String routePath = 'Dashboard';

  @override
  State<DeyeDashboardNotUsingWidget> createState() =>
      _DeyeDashboardNotUsingWidgetState();
}

class _DeyeDashboardNotUsingWidgetState
    extends State<DeyeDashboardNotUsingWidget> with TickerProviderStateMixin {
  late DeyeDashboardNotUsingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeyeDashboardNotUsingModel());
                                                                      ...
                                                                      return Center(
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              DeyeNoDataWidget(
                                                                            message:
                                                                                '🛠️ Deye systems running smoothly—no complaints at the moment.',
                                                                          ),
                                                                        ),
                                                                      );
                                                                    }
                                              ...
                                              children: [
                                                if (!FFAppState()
                                                  ...
                                                  InkWell(
                                                    ...
                                                    onLongPress: () async {
                                                      context.goNamed(
                                                          RegisterComplaint1Widget
                                                              .routeName);
                                                    },
                                                    child: FFButtonWidget(
                                                      onPressed: () async {
                                                        context.pushNamed(
                                                            DeyeAddComplaintsNotUsingWidget
                                                                .routeName);
                                                      },
                                                      text: 'Add New Ticket',
                                                      icon: Icon(
