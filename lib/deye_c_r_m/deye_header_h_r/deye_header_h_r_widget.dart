...
import 'deye_header_h_r_model.dart';
export 'deye_header_h_r_model.dart';

class DeyeHeaderHRWidget extends StatefulWidget {
  const DeyeHeaderHRWidget({super.key});

  @override
  State<DeyeHeaderHRWidget> createState() => _DeyeHeaderHRWidgetState();
}

class _DeyeHeaderHRWidgetState extends State<DeyeHeaderHRWidget> {
  late DeyeHeaderHRModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeyeHeaderHRModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<OutletRecord>(
      future: OutletRecord.getDocumentOnce(FFAppState().outletRef!),
