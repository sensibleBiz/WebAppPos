...
import '/index.dart';
import 'dealer_onboard_widget.dart' show DealerOnboardWidget;
...
class DealerOnboardModel extends FlutterFlowModel<DealerOnboardWidget> {
  ...
  // Stores action output result for [Custom Action - leadDocRefCopy] action in DealerOnboard widget.
