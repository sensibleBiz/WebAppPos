...
import 'deye_user_account_model.dart';
export 'deye_user_account_model.dart';

class DeyeUserAccountWidget extends StatefulWidget {
  const DeyeUserAccountWidget({
    super.key,
    this.outletId,
  });
  ...
  static String routeName = 'DeyeUserAccount';
  static String routePath = 'deyeUserAccount';

  @override
  State<DeyeUserAccountWidget> createState() => _DeyeUserAccountWidgetState();
}

class _DeyeUserAccountWidgetState extends State<DeyeUserAccountWidget> {
  late DeyeUserAccountModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeyeUserAccountModel());
