...
import 'delete_lead_report_model.dart';
export 'delete_lead_report_model.dart';

class DeleteLeadReportWidget extends StatefulWidget {
  const DeleteLeadReportWidget({super.key});

  static String routeName = 'deleteLeadReport';
  static String routePath = 'deleteLeadReport';

  @override
  State<DeleteLeadReportWidget> createState() => _DeleteLeadReportWidgetState();
}

class _DeleteLeadReportWidgetState extends State<DeleteLeadReportWidget> {
  late DeleteLeadReportModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeleteLeadReportModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<OutletRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<OutletRecord> deleteLeadReportOutletRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final deleteLeadReportOutletRecord =
            deleteLeadReportOutletRecordList.isNotEmpty
                ? deleteLeadReportOutletRecordList.first
                : null;

        return Title(
            title: 'deleteLeadReport',
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: PagedListView<
                                        ...
                                        OutletLeadsRecord>.separated(
                                      pagingController:
                                          _model.setListViewController(
                                              OutletLeadsRecord.collection(
                                                      FFAppState().outletRef)
                                      ...
                                      builderDelegate:
                                        ...
                                        itemBuilder:
                                          ...
                                          final listViewOutletLeadsRecord =
                                                  ...
                                                  Flexible(
                                                    child: InkWell(
                                                      ...
                                                      highlightColor:
                                                          Colors.transparent,
                                                      onTap: () async {
                                                        await listViewOutletLeadsRecord
                                                            .reference
                                                            .delete();
                                                        await showDialog(
                                                          context: context,
                                                    ...
                                                    child: StreamBuilder<
                                                      ...
                                                      builder:
                                                        ...
                                                        List<LeadsManagementRecord>
                                                            columnLeadsManagementRecordList =
                                                            snapshot.data!;
                                                        ...
                                                        return Column(
                                                          ...
                                                          children: List.generate(
                                                              columnLeadsManagementRecordList
                                                                  .length,
                                                              (columnIndex) {
                                                            final columnLeadsManagementRecord =
                                                                columnLeadsManagementRecordList[
                                                                    columnIndex];
                                                            return Expanded(
                                                              child: Row(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  InkWell(
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      await columnLeadsManagementRecord
                                                                          .reference
                                                                          .delete();
                                                                      await showDialog(
                                                                        context:
