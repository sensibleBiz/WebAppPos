...
import 'register_complaint1_model.dart';
export 'register_complaint1_model.dart';

class RegisterComplaint1Widget extends StatefulWidget {
  const RegisterComplaint1Widget({super.key});

  static String routeName = 'RegisterComplaint1';
  static String routePath = 'registerComplaint1';

  @override
  State<RegisterComplaint1Widget> createState() =>
      _RegisterComplaint1WidgetState();
}

class _RegisterComplaint1WidgetState extends State<RegisterComplaint1Widget> {
  late RegisterComplaint1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegisterComplaint1Model());
    ...
    _model.mobileAltTextController ??= TextEditingController();
    _model.mobileAltFocusNode ??= FocusNode();
              ...
              floatingActionButton: Builder(
                builder: (context) => FloatingActionButton.extended(
                  onPressed: () async {
                    ...
                    if (_model.dropDownProductionCapacityValue == null) {
                      return;
                    }
                    _model.countDocCopy = await queryOutletLeadsRecordOnce(
                      parent: FFAppState().deyeOutletId,
                      queryBuilder: (outletLeadsRecord) =>
                          outletLeadsRecord.where(
                        'date',
                        isEqualTo: functions.dateFormat(getCurrentTimestamp),
                      ),
                    );

                    var outletLeadsRecordReference =
                        OutletLeadsRecord.createDoc(FFAppState().deyeOutletId!);
                    await outletLeadsRecordReference
                      ...
                      id: functions.timestampToMili(getCurrentTimestamp),
                      logId: functions.timestampToMili(getCurrentTimestamp),
                      ...
                      status: 'Unread',
                      time: dateTimeFormat("jms", getCurrentTimestamp),
                      ...
                      customFields: createCustomFieldsStruct(
                        ...
                        purchasedFrom: _model.purchasefromTextController.text,
                        serial: _model.serialNumberTextController.text,
                        clearUnsetFields: false,
                        create: true,
                      ),
                      ticket: functions.genComplaintNum(
                          _model.countDocCopy!.length, FFAppState().zone),
                      source: 'QR',
                    ));
                    _model.outputCopy = OutletLeadsRecord.getDocumentFromData(
                    ...
                    safeSetState(() {
                      ...
                      _model.mobileAltTextController?.clear();
                      _model.emailTextController?.clear();
                      _model.phoneTextController1?.clear();
                      _model.requirementTextController?.clear();
                      _model.purchasefromTextController?.clear();
                      _model.areaTextController?.clear();
                      _model.phoneTextController2?.clear();
                      _model.serialNumberTextController?.clear();
                    });
                    safeSetState(() {
                                                ...
                                                Padding(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    keyboardType:
                                                        TextInputType.number,
                                                    validator: _model
                                                        .mobileAltTextControllerValidator
                                                        .asValidator(context),
                                                  ),
                                                ),
                                              ],
                                                  ...
                                                  children: [
                                                    ...
                                                    StreamBuilder<
                                                      ...
                                                      builder:
                                                        ...
                                                        List<CitiesRecord>
                                                            dropDownCitiesCitiesRecordList =
                                                            snapshot.data!;
