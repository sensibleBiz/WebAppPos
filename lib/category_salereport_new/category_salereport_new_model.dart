...
import 'category_salereport_new_widget.dart' show CategorySalereportNewWidget;
...
class CategorySalereportNewModel
    extends FlutterFlowModel<CategorySalereportNewWidget> {
  ///  State fields for stateful widgets in this page.

  final unfocusNode = FocusNode();
  // Stores action output result for [Custom Action - productSaleReport] action in categorySalereportNew widget.
