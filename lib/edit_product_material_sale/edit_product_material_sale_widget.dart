                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: StreamBuilder<CategoryRecord>(
                                    stream: CategoryRecord.getDocument(
                                        containerProductRecord!.categoryRef!),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      if (!snapshot.hasData) {
                                        return Center(
                                    ...
                                    Padding(
                                      ...
                                      child: Switch.adaptive(
                                        value: _model.switchValue2 ??=
                                            containerProductRecord!.isDealer,
                                        onChanged: (newValue) async {
                                          safeSetState(() =>
                                ...
                                Container(
                                  width: double.infinity,
                                  height:
                                      MediaQuery.sizeOf(context).height * 0.089,
                                  decoration: BoxDecoration(
                                    color: FlutterFlowTheme.of(context)
                                        .primaryBackground,
                                  ),
                                  child: StreamBuilder<List<UnitTypeRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<UnitTypeRecord>
                                          ...
                                          snapshot.data!;
                                      final containerUnitTypeRecord =
                                          containerUnitTypeRecordList.isNotEmpty
                                              ? containerUnitTypeRecordList
                                                  .first
                                              : null;
                                        ...
                                        child:
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            final rowCategoryRecord =
                                                rowCategoryRecordList.isNotEmpty
                                                    ? rowCategoryRecordList
                                                        .first
                                                    : null;
