...
class AddPartyWidget extends StatefulWidget {
  ...
  static String routeName = 'AddParty';
  static String routePath = 'addParty';
                                  ...
                                  onTap: () async {
                                    ...
                                    if (_model.textController1.text != null &&
                                      ...
                                      await partyRecordReference
                                        ...
                                        gstNo: _model.textController3.text,
                                      ...
                                      _model.partyDoc =
                                          PartyRecord.getDocumentFromData(
                                              createPartyRecordData(
                                                ...
                                                proofOfIdentity: '\"\"',
                                                firmName: '\"\"',
                                                role: functions.toCapitalLetter(
                                                    'SUPPLIER'),
                                                extraDetails: '\"\"',
                                                gender: '\"\"',
                                                credit: true,
                                      ...
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          return WebViewAware(
                                            child: AlertDialog(
                                              title: Text('Party Successfull'),
                                              content: Text(
                                                  'Party Added Successfull'),
                                              actions: [
                                                TextButton(
                                                  onPressed: () =>
                                                      Navigator.pop(
