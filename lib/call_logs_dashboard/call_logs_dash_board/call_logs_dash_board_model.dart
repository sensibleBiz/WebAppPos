...
import 'call_logs_dash_board_widget.dart' show CallLogsDashBoardWidget;
...
class CallLogsDashBoardModel extends FlutterFlowModel<CallLogsDashBoardWidget> {
  ...
  List<CallLogsRecord>? callLogsDashBoardPreviousSnapshot;
  // Stores action output result for [Firestore Query - Query a collection] action in CallLogsDashBoard widget.
  ...
  // Models for CallLogTeamDetails dynamic component.
  late FlutterFlowDynamicModels<CallLogTeamDetailsModel>
  ...
  void initState(BuildContext context) {
    ...
    callLogTeamDetailsModels =
        FlutterFlowDynamicModels(() => CallLogTeamDetailsModel());
  ...
  void dispose() {
    ...
    callLogTeamDetailsModels.dispose();
