...
import '/components/update_payment_widget.dart';
import '/flutter_flow/flutter_flow_icon_button.dart';
import '/flutter_flow/flutter_flow_theme.dart';
import '/flutter_flow/flutter_flow_util.dart';
import '/flutter_flow/flutter_flow_widgets.dart';
import '/custom_code/actions/index.dart' as actions;
import 'payment_master_widget.dart' show PaymentMasterWidget;
...
class PaymentMasterModel extends FlutterFlowModel<PaymentMasterWidget> {
  ...
  // Stores action output result for [Custom Action - genaratePaymentCode] action in Button widget.
  int? len;
