                ...
                body: Row(
                  ...
                  children: [
                    if ((cDealerAccountUserProfileRecord?.role == 'user') &&
                        ((cDealerAccountUserProfileRecord?.permissionList?[10])
                                ?.value !=
                            4))
                      Expanded(
                        flex: 2,
                                                  ...
                                                  child: GestureDetector(
                                                    ...
                                                    child: Padding(
                                                      padding: MediaQuery
                                                          .viewInsetsOf(
                                                              context),
                                                      child: CAddDealerWidget(
                                                        userRef:
                                                            cDealerAccountUserProfileRecord
                                                                ?.reference,
                                                      ),
                                                    ),
                                                  ),
                                                                          ...
                                                                          Container(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Column(
                                                                                ...
                                                                                children: [
                                                                                  Text(
                                                                                    listViewDealersRecord.companyName,
                                                                                    style: FlutterFlowTheme.of(context).labelLarge.override(
                                                                                          fontFamily: FlutterFlowTheme.of(context).labelLargeFamily,
                                                                                          letterSpacing: 0.0,
                                                                                          useGoogleFonts: GoogleFonts.asMap().containsKey(FlutterFlowTheme.of(context).labelLargeFamily),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Padding(
                                                                                ...
                                                                                child: Column(
                                                                                  ...
                                                                                  children: [
                                                                                    Text(
                                                                                      listViewDealersRecord.contactNumber,
                                                                                      style: FlutterFlowTheme.of(context).labelLarge.override(
                                                                                            fontFamily: FlutterFlowTheme.of(context).labelLargeFamily,
                                                                                            letterSpacing: 0.0,
                                                                                            useGoogleFonts: GoogleFonts.asMap().containsKey(FlutterFlowTheme.of(context).labelLargeFamily),
